...
<div id="mainDiv">
    ...
    <table class="fixedTable">
        ...
        <tr>
            ...
            <td class="content_center">${DataDicUtil.getDataDic("6004",map.CR_PER_PRH.PA01BD02)!}</td>
        </tr>
    </table>
    <br>
    <table class="fixedTable">
        ...
        <#list map.CR_PER_PA01CH! as CR_PER_PA01CH>
            <tr>
                <td class="content_center">${DataDicUtil.getDataDic("6002",CR_PER_PA01CH.PA01CD01)!}</td>
    ...
    <table class="fixedTable">
        ...
        <tr>
            <td class="content_center" colspan="2">${DataDicUtil.getDataDic("6003",map.CR_PER_PRH.PA01DQ01)!}联系电话：${map.CR_PER_PRH.PA01DQ02!}</td>
        </tr>
        <tr>
    ...
    <table class="fixedTable">
        ...
        <tr>
            ...
            <td class="content_center">${DataDicUtil.getDataDic("6056",map.CR_PER_PIM.PB01AD05)!}</td>
    ...
    <table class="fixedTable">
        ...
        <#list map.CR_PER_POM! as CR_PER_POM>
            <tr>
                ...
                <td class="content_center">${DataDicUtil.getDataDic("6006",CR_PER_POM.PB040D02)!}</td>
        ...
        <#list map.CR_PER_POM! as CR_PER_POM>
            <tr>
                ...
                <td class="content_center">${DataDicUtil.getDataDic("6064",CR_PER_POM.PB040D03)!}</td>
    ...
    <table class="fixedTable">
        ...
        <tr>
        	<#if map.CR_PER_PSM_0.PC010Q01 ??>
            <td class="content_center" rowspan="3">${map.CR_PER_PSM_0.PC010Q01!}</td>
            </#if>
            <#if map.CR_PER_PSM_0.PC010Q02 ?? && map.CR_PER_PSM_0.PC010Q02!="--">
            <td class="content_center" rowspan="3">>${map.CR_PER_PSM_0.PC010Q02!}%</td>
            <#else>
            <td class="content_center" rowspan="3">${map.CR_PER_PSM_0.PC010Q02!}</td>
            </#if>
            ...
            <#list map.CR_PER_PSM as CR_PER_PSM>
             <tr><td class="content_left" rowspan="1">影响因素：${DataDicUtil.getDataDic("6010",CR_PER_PSM.PC010D01)!}</td></tr>
            </#list>
    ...
    <table class="fixedTable">
        ...
        <tr>
            ...
            <td class="content_center">${map.CR_PER_PCO.PC02BS02!}</td>
        </tr>
    </table>
    <br>
    <table class="fixedTable">
    ...
    <table class="fixedTable">
        <tr>
            <td class="title_center" colspan="2">最近1个月内的查询机构数</td>
            <td class="title_center" colspan="3">最近1个月内的查询次数 </td>
            <td class="title_center" colspan="3">最近2年内的查询次数</td>
        </tr>
        <tr>
        ...
        <#if map.PDA_AD01_C1_PD01FH??>
            <table class="fixedTable">
                <tr>
                 ...
                 <#list map.PDA_AD01_C1_PD01FH! as PDA_AD01_C1_PD01FH>
                   <#if PDA_AD01_C1_PD01FH.PARENT_ID??>
	        	    <#if PDA_AD01_C1_PD01FH.PARENT_ID == PDA_AD01_C1.ID>
                <tr>
                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_C1_PD01FH.PD01FD01)!}</td>
                    <td class="content_center">${PDA_AD01_C1_PD01FH.PD01FR01!}</td>
                    <td class="content_center">${PDA_AD01_C1_PD01FH.PD01FS02!}</td>
                    <td class="content_center">${PDA_AD01_C1_PD01FH.PD01FJ01!}</td>
                    <td class="content_center">${PDA_AD01_C1_PD01FH.PD01FQ01!}</td>
                </tr>
                    </#if>
                  </#if>
                </#list>
    ...
    <#list map.PDA_AD01_D1! as PDA_AD01_D1>
        ...
        <#if map.PDA_AD01_D1_PD01GH??>
	        <#if map.PDA_AD01_D1_PD01GH.PARENT_ID??>
	        	<#if map.PDA_AD01_D1_PD01GH.PARENT_ID == PDA_AD01_D1.ID>
		            <table class="fixedTable">
		                <tr>
		                    <td class="title_center no_border_top">特殊事件说明</td>
		                </tr>
		                <#if map.PDA_AD01_D1_PD01GH.PD01GR01??>
		                <tr>
		                ...
		                <#else>
		                 <tr>
		                    <td class="content_center">${map.PDA_AD01_D1_PD01GH.PD01GR01!}${DataDicUtil.getDataDic("6038",map.PDA_AD01_D1_PD01GH.PD01GD01)!}</td>
		                </tr>
        ...
        <#if map.PDA_AD01_D1_PD01FH??>
	            <table class="fixedTable">
	                ...
	                <#list map.PDA_AD01_D1_PD01FH! as PDA_AD01_D1_PD01FH>
	                   <#if PDA_AD01_D1_PD01FH.PARENT_ID??>
	        	         <#if PDA_AD01_D1_PD01FH.PARENT_ID == PDA_AD01_D1.ID>
	                <tr>
	                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_D1_PD01FH.PD01FD01)!}</td>
	                    <td class="content_center">${PDA_AD01_D1_PD01FH.PD01FR01!}</td>
	                    <td class="content_center">${PDA_AD01_D1_PD01FH.PD01FS02!}</td>
	                    <td class="content_center">${PDA_AD01_D1_PD01FH.PD01FJ01!}</td>
	                    <td class="content_center">${PDA_AD01_D1_PD01FH.PD01FQ01!}</td>
	                </tr>
	                    </#if>
	                   </#if>
	                </#list>
        ...
        <#--标注及声明信息-->
        <#list map.PDA_AD01_D1_PD01ZH! as PDA_AD01_D1_PD01ZH_OUTER>
            <#if PDA_AD01_D1_PD01ZH_OUTER.PARENT_ID == PDA_AD01_D1.ID>
	            <#list PDA_AD01_D1_PD01ZH_OUTER.LIST! as  PDA_AD01_D1_PD01ZH>
	                <table class="fixedTable">
	                    <tr>
        ...
        <#if map.PDA_AD01_R4_PD01FH??>
            <table class="fixedTable">
                <tr>
                 ...
                 <#list map.PDA_AD01_R4_PD01FH! as PDA_AD01_R4_PD01FH>
                     <#if PDA_AD01_R4_PD01FH.PARENT_ID??>
	        	      <#if PDA_AD01_R4_PD01FH.PARENT_ID == PDA_AD01_R4.ID>
                <tr>
                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_R4_PD01FH.PD01FD01)!}</td>
                    <td class="content_center">${PDA_AD01_R4_PD01FH.PD01FR01!}</td>
                    <td class="content_center">${PDA_AD01_R4_PD01FH.PD01FS02!}</td>
                    <td class="content_center">${PDA_AD01_R4_PD01FH.PD01FJ01!}</td>
                    <td class="content_center">${PDA_AD01_R4_PD01FH.PD01FQ01!}</td>
                </tr>
                     </#if>
                    </#if>
                </#list>
    ...
    <#list map.PDA_AD01_R1! as PDA_AD01_R1>
        ...
        <table class="fixedTable">
            ...
            <#if PDA_AD01_R1_PD01EH_OUTER.PARENT_ID == PDA_AD01_R1.ID>
            	<#list PDA_AD01_R1_PD01EH_OUTER.LIST! as PDA_AD01_R1_PD01EH>
                <tr>
        ...
        <#if map.PDA_AD01_R1_PD01FH??>
            <table class="fixedTable">
                <tr>
                 ...
                 <#list map.PDA_AD01_R1_PD01FH! as PDA_AD01_R1_PD01FH>
                    <#if PDA_AD01_R1_PD01FH.PARENT_ID??>
	        	      <#if PDA_AD01_R1_PD01FH.PARENT_ID == PDA_AD01_R1.ID>
                <tr>
                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_R1_PD01FH.PD01FD01)!}</td>
                    <td class="content_center">${PDA_AD01_R1_PD01FH.PD01FR01!}</td>
                    <td class="content_center">${PDA_AD01_R1_PD01FH.PD01FS02!}</td>
                    <td class="content_center">${PDA_AD01_R1_PD01FH.PD01FJ01!}</td>
                    <td class="content_center">${PDA_AD01_R1_PD01FH.PD01FQ01!}</td>
                </tr>
                     </#if>
                    </#if>
                </#list>
    ...
    <#list map.PDA_AD01_R2! as PDA_AD01_R2>
        ...
        <#--最新表现信息  -->
         <#if PDA_AD01_R2.PD01BD01?? | PDA_AD01_R2.PD01CD01?? >
		 	<#if PDA_AD01_R2.PD01BD01?? >
		 		 <#if PDA_AD01_R2.PD01BD01 == '4' >
		             <#--销户-->
		            <table class="fixedTable">
		                <tr>
		                    <td class="title_center no_border_top" colspan="2">截至${PDA_AD01_R2.PD01BR03!}</td>
		                </tr>
		                <tr>
		                    <td class="title_center" >账户状态</td>
		    ...
		    <#elseif PDA_AD01_R2.PD01CD01??>  
		    	    <#if PDA_AD01_R2.PD01CD01 == '4' >
		    	    <#--销户-->
		            <table class="fixedTable">
		                <tr>
		                    <td class="title_center no_border_top" colspan="2">截至${PDA_AD01_R2.PD01BR03!}</td>
		  ...
		  <#if PDA_AD01_R2.PD01BD01?? | PDA_AD01_R2.PD01CD01?? >
		  	<#if PDA_AD01_R2.PD01BD01?? >
		  		 <#if PDA_AD01_R2.PD01BD01 == '5'>
		            <#--呆账-->
		            <table class="fixedTable">
		                <tr>
		                    <td class="title_center no_border_top"  colspan="3">截至${PDA_AD01_R2.PD01BR03!}</td>
		                </tr>
		                <tr>
		                    <td class="title_center">账户状态</td>
		                    <td class="title_center">余额</td>
		...
		<#if map.PDA_AD01_R2_PD01GH.PD01GR01??>
                <tr>
			...
			<#else>
		               <tr>
                         <td class="content_center">${map.PDA_AD01_R2_PD01GH.PD01GR01!}${map.PDA_AD01_R2_PD01GH.PD01GD01!}</td>
                      </tr>
        ...
        <#if map.PDA_AD01_R2_PD01FH??>
            <table class="fixedTable">
                <tr>
                 ...
                 <#list map.PDA_AD01_R2_PD01FH! as PDA_AD01_R2_PD01FH>
                    <#if PDA_AD01_R2_PD01FH.PARENT_ID??>
	        	      <#if PDA_AD01_R2_PD01FH.PARENT_ID == PDA_AD01_R2.ID>
                <tr>
                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_R2_PD01FH.PD01FD01)!}</td>
                    <td class="content_center">${PDA_AD01_R2_PD01FH.PD01FR01!}</td>
                    <td class="content_center">${PDA_AD01_R2_PD01FH.PD01FS02!}</td>
                    <td class="content_center">${PDA_AD01_R2_PD01FH.PD01FJ01!}</td>
                    <td class="content_center">${PDA_AD01_R2_PD01FH.PD01FQ01!}</td>
                </tr>
                     </#if>
                    </#if>
                </#list>
    ...
    <#list map.PDA_AD01_R3! as PDA_AD01_R3>
        <#--基本信息-->
        <h4 class="title_left" style="margin-left:20px; ">账户${PDA_AD01_R3.PD01AI01!}（授信协议标识：${PDA_AD01_R3.PD01AI04!}）</h4>
        <table class="fixedTable">
            <tr>
                <td class="title_center">发卡机构</td>
                <td class="title_center">账户标识</td>
        ...
        <#--最新表现信息-->
        <#if PDA_AD01_R3.PD01BD01?? | PDA_AD01_R3.PD01CD01??>
        	<#if PDA_AD01_R3.PD01BD01??>
		      ...
		      <#elseif  PDA_AD01_R3.PD01CD01??>
        		<#if PDA_AD01_R3.PD01CD01 == '4' >
        			<#--销户-->
		            <table class="fixedTable">
		                <tr>
		                    <td class="title_center no_border_top" colspan="2">截至${PDA_AD01_R3.PD01BR03!}</td>
        ...
        <#if PDA_AD01_R3.PD01CD01 != '6'>
            <table class="fixedTable">
                ...
                <#if PDA_AD01_R3_PD01EH.PARENT_ID == PDA_AD01_R3.ID>
                <#list PDA_AD01_R3_PD01EH.LIST! as PDA_AD01_R3_PD01EH>              
                    <tr>
        ...
        <#if map.PDA_AD01_R3_PD01FH??>
            <table class="fixedTable">
                <tr>
                 ...
                 <#list map.PDA_AD01_R3_PD01FH! as PDA_AD01_R3_PD01FH>
                    <#if PDA_AD01_R3_PD01FH.PARENT_ID??>
	        	      <#if PDA_AD01_R3_PD01FH.PARENT_ID == PDA_AD01_R3.ID>
                <tr>
                    <td class="content_center">${DataDicUtil.getDataDic("6037",PDA_AD01_R3_PD01FH.PD01FD01)!}</td>
                    <td class="content_center">${PDA_AD01_R3_PD01FH.PD01FR01!}</td>
                    <td class="content_center">${PDA_AD01_R3_PD01FH.PD01FS02!}</td>
                    <td class="content_center">${PDA_AD01_R3_PD01FH.PD01FJ01!}</td>
                    <td class="content_center">${PDA_AD01_R3_PD01FH.PD01FQ01!}</td>
                </tr>
                     </#if>
                    </#if>
                </#list>
    ...
    <h2>四  非信贷交易信息明细</h2>
<#list map.CR_PER_PND! as CR_PER_PND>
<h3>后付费记录</h3>
    <h4 class="title_left" style="margin-left:20px; ">账户${CR_PER_PND.PE01AD01!}</h4>
    <#--基本信息-->
    <table class="fixedTable">
        <tr>
        ...
        <tr>
            <td class="content_center">${CR_PER_PND.PE01AQ01!}</td>
            <td class="content_center">${DataDicUtil.getDataDic("6046",CR_PER_PND.PE01AD02)!}后付费</td>
            <td class="content_center">${CR_PER_PND.PE01AR01!}</td>
            <td class="content_center">${DataDicUtil.getDataDic("6047",CR_PER_PND.PE01AD03)!}</td>
            <td class="content_center">${CR_PER_PND.PE01AJ01!}</td>
            <td class="content_center">${CR_PER_PND.PE01AR02!}</td>
        </tr>
    </table>
    <#--近两年缴费记录-->
    <#if CR_PER_PND.CR_PER_PN_AQ02??>
        <table class="fixedTable">
            <tr>
                <td class="title_center no_border_top" colspan="13">${CR_PER_PND.PE01AR02_START!}—${CR_PER_PND.PE01AR02!}的缴费记录 </td>
            </tr>
            <tr>
                <td class="title_center"></td>
                <td class="title_center">1</td>
            ...
            <#list CR_PER_PND.CR_PER_PN_AQ02 as CR_PER_PN_AQ02>
                <tr>
                    <td class="title_center">${CR_PER_PN_AQ02.YEAR!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M01!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M02!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M03!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M04!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M05!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M06!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M07!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M08!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M09!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M10!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M11!}</td>
                    <td class="content_center">${CR_PER_PN_AQ02.M12!}</td>
                </tr>
            </#list>
        </table>
    </#if>
...
<br>
    ...
    <table class="fixedTable">
        ...
        <#list map.CR_PER_PG010H_3! as CR_PER_PG010H_3>
        <tr>
            <td class="content_center">${CR_PER_PG010H_3_index + 1 !}</td>
            <td class="content_center">${CR_PER_PG010H_3.PG010Q01!}</td>
            <td class="content_center">${CR_PER_PG010H_3.PG010R01!}</td>
        </tr>
        </#list>
    </table>
    <br>
    ...
    <table class="fixedTable">
        ...
        <#list map.CR_PER_PG010H_1! as CR_PER_PG010H_1>
        <tr>
            <td class="content_center">${CR_PER_PG010H_1_1_index + 1 !}</td>
            <td class="content_center">${CR_PER_PG010H_1.PG010Q01!}</td>
            <td class="content_center">${CR_PER_PG010H_1.PG010R01!}</td>
        </tr>
        </#list>
    ...
    <table class="fixedTable">
        ...
        <#list map.CR_PER_POQ! as CR_PER_POQ>
            <tr>
                <td class="content_center">${CR_PER_POQ_index + 1 !}</td>
                <td class="content_center">${CR_PER_POQ.PH010R01!}</td>
                <td class="content_center">${CR_PER_POQ.PH010Q02!}</td>
                <td class="content_center">${DataDicUtil.getDataDic("6004",CR_PER_POQ.PH010Q03)!}</td>
            </tr>
        </#list>
    </table>
    <br>
