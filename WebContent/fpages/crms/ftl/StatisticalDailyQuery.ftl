...
<@CommonQueryMacro.page title="统计日查询量">
<table width="100%" align="left">
<tr>
<td>
<@CommonQueryMacro.CommonQuery id="StatisticalDailyQuery" init="false" submitMode="selected">
	<table width="100%">
		<tr>
...
function flushData() {
    StatisticalDailyQuery_dataset.flushData(1);
}
</script>
