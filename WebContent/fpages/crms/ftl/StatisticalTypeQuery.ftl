...
<@CommonQueryMacro.page title="统计查询类型">
<table width="100%" align="left">
<tr>
<td>
<@CommonQueryMacro.CommonQuery id="StatisticalTypeQuery" init="false" submitMode="selected">
	<table width="100%">
		<tr>
...
function flushData() {
    StatisticalTypeQuery_dataset.flushData(1);
}
</script>
