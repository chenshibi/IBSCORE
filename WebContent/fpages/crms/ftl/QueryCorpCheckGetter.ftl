...
<@CommonQueryMacro.page title="企业征信查询审核">
<table width="100%" align="left">
<tr>
<td>
<@CommonQueryMacro.CommonQuery id="QueryCorpCheckGetter" init="false" submitMode="selected">
	<table width="100%">
		<tr>
...
function btBatchApprove_onClickCheck() {
    if (!isRecordSelected(QueryCorpCheckGetter_dataset)) {
        alert("请选择一条记录！");
        return false;
    }
    return true;
...
function flushData() {
    QueryCorpCheckGetter_dataset.flushData(1);
}
