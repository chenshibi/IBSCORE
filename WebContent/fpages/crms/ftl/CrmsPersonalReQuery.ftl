...
<@CommonQueryMacro.page title="个人征信重新查询">
<table width="100%" align="left">
<tr>
<td>
<@CommonQueryMacro.CommonQuery id="CrmsPersonalReQuery" init="false" submitMode="selected">
	<table width="100%">
		<tr>
...
function btBatchApprove_onClickCheck() {
    if (!isRecordSelected(CrmsPersonalReQuery_dataset)) {
        alert("请选择一条记录！");
        return false;
    }
    return true;
...
function flushData() {
    CrmsPersonalReQuery_dataset.flushData(1);
}
