...
<@CommonQueryMacro.page title="授权资料查询">
<table width="100%" align="left">
<tr>
<td>
<@CommonQueryMacro.CommonQuery id="GrantAuthDataQuery" init="false" submitMode="selected">
	<table width="100%">
		<tr>
...
<script language="javascript">
    function flushData() {
        GrantAuthDataQuery_dataset.flushData(1);
    }
