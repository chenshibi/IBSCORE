...
<table width="1366px" align="left">
 	<tr>
      	<td>
			<@CommonQueryMacro.CommonQuery id="CompanyReportFormdownload" init="false" submitMode="current">
				<table width="100%">
					<tr>
						<td valign="top">
...
<script language="javascript">
	...
	function btDownload_onClickCheck(){
		var reportDate = CompanyReportFormdownload_interface_dataset.getValue("reportDate");
	...
	function btDownload_onClick(){
		...
		//alert("${contextPath}/reportForm/DownloadReportFormAction.do");
	            else{
