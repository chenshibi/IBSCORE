...
<table width="1366px" align="left">
 	<tr>
      	<td>
			<@CommonQueryMacro.CommonQuery id="AssureReportFormdownload" init="false" submitMode="current">
				<table width="100%">
					<tr>
						<td valign="top">
...
<script language="javascript">
		var page = "${statics["com.huateng.htaml.reportForm.util.ReportFormUtils"].PAGE_19}";
	function onClickCheck(){
		var reportDate = AssureReportFormdownload_interface_dataset.getValue("reportDate");
	...
	function btDownload_onClick(){
	    ...
	    dwr.engine.setAsync(false);
	     ...
	     PrivAction.getAssureReport(reportDate,
	            function(data){
	                   usrList = data;
	            }
	     );
	     dwr.engine.setAsync(true);
	            ...
	            if(!usrList){
	               alert("The file does not exists!");
					...
					window.location.href = "${contextPath}/reportForm/DownloadAction.do?page="+page+"&reportDate="+reportDate;
	            }
	}
</script>
