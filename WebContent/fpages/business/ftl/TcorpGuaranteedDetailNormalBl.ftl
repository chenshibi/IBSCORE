...
<@CommonQueryMacro.page title="正常类保理">
<table align="left" width="100%">
<tr>

<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailNormalBlBzrQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailNormalBlBzrQuery_table">
<tr valign="center">
	<td align="center">
	<h3>保证人信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailNormalBlDywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailNormalBlDywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>抵押物信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailNormalBlZywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailNormalBlZywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>质押物信息</h3>
	</td>
