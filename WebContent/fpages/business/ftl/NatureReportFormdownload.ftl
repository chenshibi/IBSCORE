...
<table width="1366px" align="left">
 	<tr>
      	<td>
			<@CommonQueryMacro.CommonQuery id="NatureReportFormdownload" init="false" submitMode="current">
				<table width="100%">
					<tr>
						<td valign="top">
...
<script language="javascript">
		var page = "${statics["com.huateng.htaml.reportForm.util.ReportFormUtils"].PAGE_18}";
	function btDownload_onClickCheck(){
		var reportDate = NatureReportFormdownload_interface_dataset.getValue("reportDate");
