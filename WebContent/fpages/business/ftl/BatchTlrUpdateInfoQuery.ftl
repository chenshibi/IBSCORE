...
<@CommonQueryMacro.CommonQuery id="batchTlrUpdateInfo" init="false" submitMode="current">
<table  width="80%">
    <tr>
		<td>
...
function batchTlrUpdateInfo_interface_dataset_btnSubmit_onClickCheck(){
	var startDate = batchTlrUpdateInfo_interface_dataset.getValue("startDate");
	var endDate = batchTlrUpdateInfo_interface_dataset.getValue("endDate");
...
function datatable1_opr_onRefresh(cell,value,record) {
	...
	function showdetail(batchId){
		...
		var url = "/fpages/business/ftl/BatchTlrUpdateInfoDetailQuery.ftl?batchId="+batchId;
