...
<body>
<form action="BatchNaturePersonCodeQueryAction.do" method="post" enctype="multipart/form-data" name="uploadExcelform" target="checkExcelWindow">
	...
	<table width="30%" align=center>
		<tr >
			<td  valign="bottom" >
				...
				<input type="button" value="批量文件template下载" id="subbtnd" onclick="return downLoad(this);" style="width:160px;height:20px">
			</td>
		</tr>
	</table>
	<tr>
...
<script type="text/javascript">
	...
	function ExcelImport(obj){
		...
		uploadExcelform.action = "<%=request.getContextPath()%>/BatchNaturePersonCodeQueryAction.do";
		uploadExcelform.submit();
			alert("提交成功,正在导入......");
		if(flag == true){
		}
		window.location='BatchNaturePersonCodeQuery.jsp';
		return true;
	}
	
	function downLoad(obj){
		uploadExcelform.action = "<%=request.getContextPath()%>/NaturePersonCodeTemplateDownloadAction.do";
		uploadExcelform.submit();
	}
</script>
</body>
