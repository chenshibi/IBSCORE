...
<@CommonQueryMacro.page title="许可文件上传报表下载">
<table width="1366px" align="left">
 	<tr>
      	<td>
			<@CommonQueryMacro.CommonQuery id="PermissionFileSubmitJobdownload" init="false" submitMode="current">
				<table width="100%">
					<tr>
						<td valign="top">
...
<script language="javascript">
		...
		var reportDate = PermissionFileSubmitJobdownload_interface_dataset.getValue("reportDate");
	...
	function btDownload_onClick(){
		...
		window.location.href = "${contextPath}/reportForm/PermissionFileSubmitJobdownloadAction.do?reportDate="+reportDate;
	            }
