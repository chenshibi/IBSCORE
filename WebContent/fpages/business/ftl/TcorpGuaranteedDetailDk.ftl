...
<@CommonQueryMacro.page title="不良关注类贷款">
<table align="left" width="100%">
<tr>

<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailDkBzrQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailDkBzrQuery_table">
<tr valign="center">
	<td align="center">
	<h3>保证人信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailDkDywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailDkDywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>抵押物信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailDkZywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailDkZywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>质押物信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpExtendedDetailDkZqQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpExtendedDetailDkZqQuery_table">
<tr valign="center">
	<td align="center">
	<h3>展期信息</h3>
	</td>
