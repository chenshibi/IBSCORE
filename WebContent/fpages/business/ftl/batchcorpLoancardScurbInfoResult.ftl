...
<@CommonQueryMacro.CommonQuery id="batchcorpLoancardScurbInfoResult" init="false" submitMode="current">
<table  width="80%">
    <tr>
		<td>
...
function batchcorpLoancardScurbInfoResult_interface_dataset_btnSubmit_onClickCheck(){
		var startDate = batchcorpLoancardScurbInfoResult_interface_dataset.getValue("startDate");
		var endDate = batchcorpLoancardScurbInfoResult_interface_dataset.getValue("endDate");
...
function datatable1_opr_onRefresh(cell,value,record) {
	...
	function showdetail(batchId){
		...
		//loadPageWindows("partWin","查看明细","/fpages/business/ftl/batchcorpLoancardScurbInfoResultDetail.ftl", paramMap, "winZone");
		var url = "/fpages/business/ftl/batchcorpLoancardScurbInfoResultDetail.ftl?batchId="+batchId;
