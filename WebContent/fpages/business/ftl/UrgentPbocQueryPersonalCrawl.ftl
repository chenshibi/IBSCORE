...
<@CommonQueryMacro.page title="提交二代个人征信报告爬网查询请求（紧急）">
<@CommonQueryMacro.CommonQuery id="UrgentPbocQueryPersonalCrawl" init="false" submitMode="current">
...
<script language="javascript">
 function initCallGetter_post(dataset) {
      UrgentPbocQueryPersonalCrawl_dataset.setValue("serviceCode","FW_GRXYBG_0074");
      UrgentPbocQueryPersonalCrawl_dataset.setValue("queryLevel","2");
    }

var aCity={11:"北京",12:"天津",13:"河北",14:"山西",15:"内蒙古",21:"辽宁",22:"吉林",23:"黑龙江",31:"上海",32:"江苏",33:"浙江",34:"安徽",35:"福建",36:"江西",37:"山东",41:"河南",42:"湖北",43:"湖南",44:"广东",45:"广西",46:"海南",50:"重庆",51:"四川",52:"贵州",53:"云南",54:"西藏",61:"陕西",62:"甘肃",63:"青海",64:"宁夏",65:"新疆",71:"台湾",81:"香港",82:"澳门",91:"国外"};

   	function btSearch_onClickCheck(button){
      var name=UrgentPbocQueryPersonalCrawl_dataset.getValue("name");
      var idType=UrgentPbocQueryPersonalCrawl_dataset.getValue("idType");
      var idNum_1=UrgentPbocQueryPersonalCrawl_dataset.getValue("idNum");
      var queryReason=UrgentPbocQueryPersonalCrawl_dataset.getValue("queryReason");
      var serviceCode=UrgentPbocQueryPersonalCrawl_dataset.getValue("serviceCode");
      if(name==""){
         alert("用户姓名不可为空");
         return false;
      }
      ...
      if(iSum%11!=1) {
	   ...
	   UrgentPbocQueryPersonalCrawl_dataset.setValue("nonWorkhourFilepath",nonWorkhourFilepath);
