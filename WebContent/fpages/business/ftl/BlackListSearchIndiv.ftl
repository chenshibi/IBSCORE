...
<@CommonQueryMacro.page title="黑名单个人查询">
<style>
a:link,a:visited{font-size:16px}
</style>
<@CommonQueryMacro.CommonQuery id="BlackListSearchIndiv" init="false" submitMode="current" navigate="false">
	<table align="left" width="100%">
     ...
     <tr>
      		<td>
      			<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="insertNewIndividual" fieldStr="opr[60],custId,idType,nameChn[120],nameEng[120],product,reason,status,loanNo" readonly="true" width="100%"/>
      		</td>
     </tr>
</table>
