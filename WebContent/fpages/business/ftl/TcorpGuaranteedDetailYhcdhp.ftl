...
<@CommonQueryMacro.page title="不良关注类银行承兑汇票">
<table align="left" width="100%">
<tr>

<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailYhcdhpBzrQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailYhcdhpBzrQuery_table">
<tr valign="center">
	<td align="center">
	<h3>保证人信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailYhcdhpDywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailYhcdhpDywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>抵押物信息</h3>
	</td>
...
<@CommonQueryMacro.CommonQuery id="TcorpGuaranteedDetailYhcdhpZywQuery" init="true" submitMode="all" navigate="false" insertOnEmpty="true">
<table width="100%" id="TcorpGuaranteedDetailYhcdhpZywQuery_table">
<tr valign="center">
	<td align="center">
	<h3>质押物信息</h3>
	</td>
