...
<script type="text/javascript">
	...
	function ExcelImport(obj){
		...
		uploadExcelform.action = "<%=request.getContextPath()%>/BatchNaturePersonQueryAction.do";
		uploadExcelform.submit();
			alert("提交成功,正在导入......");
		if(flag == true){
		}
		window.location='BatchNaturePersonQuery.jsp';
		return true;
	}
	function downLoad(obj){
		uploadExcelform.action = "<%=request.getContextPath()%>/NaturePersonTemplateDownloadAction.do";
		uploadExcelform.submit();
	}
</script>
</body>
