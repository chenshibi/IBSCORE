...
<@CommonQueryMacro.CommonQuery id="IndAppCommon" init="false" submitMode="all">
	...
	<table width="100%"  >
    		...
    		<td colspan="2" align="center">
				<@CommonQueryMacro.Button id= "btSubmitSave"/>
 ...
 function initCallGetter_post(dataset) {
	...
	function companyBtNew_onClick(button){
		...
		var record = IndAppCommon_dataset.lastUnit;
			...
			var isExpire=PrivAction.isExpire(inqCustIdType,inqCustName1,inqCustId1,queryReason1);
			 dwr.engine.setAsync(false);
			 if(isExpire == "0"){
	...
	var v1=0;
	function btSubmitSave_onClickCheck(button){
		var reg=/^[\s ]|[ ]$/gi;
		...
		queryReason1=encodeURI(encodeURI(queryReason));
			 dwr.engine.setAsync(false);
			 var isExpire=PrivAction.isExpire(inqCustIdType,inqCustName,inqCustId,queryReason);
    ...
    function btSubmitSave_postSubmit(button){
    	...
    	if(flag=="1"){
    		...
    		button.url="/fpages/business/ftl/IndAppRequestEmergency.ftl";
