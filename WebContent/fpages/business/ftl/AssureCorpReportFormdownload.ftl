...
<table width="1366px" align="left">
 	<tr>
      	<td>
			<@CommonQueryMacro.CommonQuery id="AssureCorpReportFormdownload" init="false" submitMode="current">
				<table width="100%">
					<tr>
						<td valign="top">
...
<script language="javascript">
		var page1 = "${statics["com.huateng.htaml.reportForm.util.ReportFormUtils"].PAGE_20}";
	function onClickCheck(){
		var reportDate = AssureCorpReportFormdownload_interface_dataset.getValue("reportDate");
	...
	function btDownload1_onClick(){
	    ...
	    dwr.engine.setAsync(false);
	     ...
	     PrivAction.getAssureCorpReport(reportDate,
	            function(data){
	                   usrList = data;
	            }
	     );
	     dwr.engine.setAsync(true);
	            ...
	            if(!usrList){
	               alert("The file does not exists!");
					...
					window.location.href = "${contextPath}/reportForm/DownloadAction.do?page="+page1+"&reportDate="+reportDate;
	            }
	}
</script>
