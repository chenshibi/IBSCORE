...
<body id="body">
	...
	%>
	<form action="<%=request.getContextPath()%>/amlBatchImport/uploadBN.spring"
		...
		<input type="hidden" name="workDate" id="workDate"
			value="<c:out value='${workDate}'/>">
		<table id="mytable" cellspacing="0">
			<tr>
				<td id="uploadFile.title"  style="width:20%;text-align:right;height:60px">Please select the bureau xls file:</td>
			...
			<tr >
				<td  valign="bottom" style="width:20%;text-align:right;height:60px">
					<input type="button" value="the template Excel: individual" id="subbtn" onclick="return downLoad(this);" style="width:200px;height:20px">
				</td>
			</tr>
		</table>
	</form>
	<script language="javascript">
		...
		//下载模板文件
		function download(){
			window.location.href = "<%=request.getContextPath()%>/filedownload/BNSplitConfirmimportAction.do";
		}
