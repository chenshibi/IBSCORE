...
function goback(){
	//window.location.href="${contextPath}/fpages/assure/ftl/AssureIndCustTotalNew.ftl";
	closeWin();
}
function printHtml(){
	...
	document.body.appendChild(sfForm);
		...
		var url = "${contextPath}/PrintAssureTotleCustGuarantDetailAction.do";
		sfForm.action = url;
		sfForm.submit();	
}
function printme(){
...
<#list AssureIndGuaranteeGuarantDetailList as guarantList  >
    <tr>
       <td height="30" valign="bottom">
          <div align="center"><font color="#0066cc"><span class="high"><b>保证合同详细信息</b></span></font></div>
       </td>
    </tr>
    <tr></br>
       <td>
                <table cellspacing="0" cellpadding="0" width="90%" border="0"
                    ...
                    <tr height="30" align="center">
                    	<td class="tdStyle" width="20%"><font color="#0066cc">质押合同编号</font>
                        </td>
                    ...
                    <tr height="30" align="center">
                    	 <td class="tdStyle" width="5%" ><font color="#0066cc"> 质押合同金额</font>
                        </td>
                         <td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                    ...
                    <tr height="30"  align="center">
                    	<td class="tdStyle" width="15%" ><font color="#0066cc"> 本担保人保证质押金额</font>
                        </td>
                    	<td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                                        class="high">${guarantList.guarantee_amount}</span></font></div>
                        </td>
                    	<td class="tdStyle" width="5%" ><font color="#0066cc"> 本担保人保证质押金额计量币种</font>
                        </td>
                    	<td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                     ...
                     <tr height="30" align="center">
                        ...
                        <td class="tdStyle" width="30%">
                     	...
                     	<td class="tdStyle" width="5%"><font color="#0066cc"> 质押合同有效状态</font>
                        </td>
                        <td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                    ...
                    <tr height="30" align="center">
                        <td class="tdStyle" width="15%" ><font color="#0066cc"> 质押合同签订日期</font>
                        </td>
                        <td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                                        class="high">${guarantList.contract_sign_date}</span></font></div>
                        </td>
                         <td class="tdStyle" width="15%" ><font color="#0066cc"> 质押保证形式</font>
                        </td>
                        <td class="tdStyle" width="10%">
                            <div class="high" align="center"><font color="#0066cc"><span 
                                        class="high">${guarantList.contract_style}</span></font></div>
                        </td>
...
<#list AssureIndGuarantorList as AssureIndGuarantorlist  >
       ...
       <td height="30" valign="bottom">
          <div align="center"><font color="#0066cc"><span class="high"><b>该质押合同对应主业务汇总信息</b></span></font></div>
       </td>
    </tr>
    <tr></br>
       <td>
