...
<@CommonQueryMacro.DataTable id ="datatable1" fieldStr="id[220],tlrno,tlrName[150],crtDt,updTransCd" width="100%" readonly="true" hasFrame="true" />	
 </FIELDSET>
...
<tr>
 ...
 <td>
  ...
  <td >
  	...
  	<@CommonQueryMacro.Button id= "btApproveTlr"/>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<@CommonQueryMacro.Button id= "btBackTlr"/>
  </td>
  </tr>
  </table>
  </@CommonQueryMacro.CommonQuery>
...
function btApproveTlr_onClickCheck(button){
