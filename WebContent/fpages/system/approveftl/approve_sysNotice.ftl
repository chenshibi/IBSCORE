...
<#--jianxue.zhang-->
<@CommonQueryMacro.page title="系统公告维护审批">
<table width="800px" align="left">
 <tr>
 <td>
<@CommonQueryMacro.CommonQuery id="approve_sysNotice" init="true"  navigate="true" submitMode="all">
 <FIELDSET name='intface' style="padding: 8px;"><LEGEND>&nbsp;待审批系统公告维护列表&nbsp;</LEGEND>
<@CommonQueryMacro.DataTable id ="datatable1" fieldStr="id[220],noticeTitle[300],startDate[120],endDate[120],crtDt,updTransCd" width="100%" readonly="true" hasFrame="true" />	
 </FIELDSET>
...
function btApprove_onClickCheck(button){
	approve_common_dataset.setValue("intInsId","120199");
