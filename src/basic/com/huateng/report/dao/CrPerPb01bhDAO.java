...
@Repository
public class CrPerPb01bhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPb01bhDAO.class);

    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPb01bh pojo) {
    ...
    public void save(CrPerPb01bh pojo) {
    ...
    public void delete(CrPerPb01bh pojo) {
    ...
    public CrPerPb01bh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPb01bh)this.getHibernateTemplate().get(CrPerPb01bh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPb01bh> findByProperties(CrPerPb01bh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPb01bh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPb01bq01())){
                queryString.append(" and model.pb01bq01 = ? ");
                binds.add(pojo.getPb01bq01());
            }
            if(isNotBlankOrNull(pojo.getPb01br01())){
                queryString.append(" and model.pb01br01 = ? ");
                binds.add(pojo.getPb01br01());
            }
            ...
            return (List<CrPerPb01bh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPb01bh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPb01bh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
