...
@Repository
public class CrComEbcDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEbcDAO.class);

    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrComEbc pojo) {
    ...
    public void save(CrComEbc pojo) {
    ...
    public void delete(CrComEbc pojo) {
    ...
    public CrComEbc findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEbc)this.getHibernateTemplate().get(CrComEbc.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEbc> findByProperties(CrComEbc pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEbc as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getEb03as01())){
                queryString.append(" and model.eb03as01 = ? ");
                binds.add(pojo.getEb03as01());
            }
            if(isNotBlankOrNull(pojo.getEb03bs01())){
                queryString.append(" and model.eb03bs01 = ? ");
                binds.add(pojo.getEb03bs01());
            }
            ...
            return (List<CrComEbc>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEbc> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEbc>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
