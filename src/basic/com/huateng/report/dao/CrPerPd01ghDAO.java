...
@Repository
public class CrPerPd01ghDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPd01ghDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPd01gh pojo) {
        log.info("updates pojo instance with id: " + pojo.getId());
        try {
    ...
    public void save(CrPerPd01gh pojo) {
    ...
    public void delete(CrPerPd01gh pojo) {
    ...
    public CrPerPd01gh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPd01gh)this.getHibernateTemplate().get(CrPerPd01gh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01gh> findByProperties(CrPerPd01gh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPd01gh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPd01gr01())){
                queryString.append(" and model.pd01gr01 = ? ");
                binds.add(pojo.getPd01gr01());
            }
            if(isNotBlankOrNull(pojo.getPd01gd01())){
                queryString.append(" and model.pd01gd01 = ? ");
                binds.add(pojo.getPd01gd01());
            }
            ...
            return (List<CrPerPd01gh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01gh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPd01gh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
