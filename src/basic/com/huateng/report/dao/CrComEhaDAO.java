...
@Repository
public class CrComEhaDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEhaDAO.class);
    ...
    public void update(CrComEha pojo) {
    ...
    public void save(CrComEha pojo) {
    ...
    public void delete(CrComEha pojo) {
    ...
    public CrComEha findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEha)this.getHibernateTemplate().get(CrComEha.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEha> findByProperties(CrComEha pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEha as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getEh010i01())){
                queryString.append(" and model.eh010i01 = ? ");
                binds.add(pojo.getEh010i01());
            }
            if(isNotBlankOrNull(pojo.getEh010q01())){
                queryString.append(" and model.eh010q01 = ? ");
                binds.add(pojo.getEh010q01());
            }
            if(isNotBlankOrNull(pojo.getEh010r01())){
                queryString.append(" and model.eh010r01 = ? ");
                binds.add(pojo.getEh010r01());
            }
            if(isNotBlankOrNull(pojo.getEh010d01())){
                queryString.append(" and model.eh010d01 = ? ");
                binds.add(pojo.getEh010d01());
            }
            ...
            return (List<CrComEha>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEha> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEha>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
