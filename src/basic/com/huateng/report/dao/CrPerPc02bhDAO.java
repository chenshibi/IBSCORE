...
@Repository
public class CrPerPc02bhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc02bhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc02bh pojo) {
    ...
    public void save(CrPerPc02bh pojo) {
    ...
    public void delete(CrPerPc02bh pojo) {
    ...
    public CrPerPc02bh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc02bh)this.getHibernateTemplate().get(CrPerPc02bh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02bh> findByProperties(CrPerPc02bh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc02bh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc02bd01())){
                queryString.append(" and model.pc02bd01 = ? ");
                binds.add(pojo.getPc02bd01());
            }
            if(isNotBlankOrNull(pojo.getPc02bs03())){
                queryString.append(" and model.pc02bs03 = ? ");
                binds.add(pojo.getPc02bs03());
            }
            if(isNotBlankOrNull(pojo.getPc02bj02())){
                queryString.append(" and model.pc02bj02 = ? ");
                binds.add(pojo.getPc02bj02());
            }
            ...
            return (List<CrPerPc02bh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02bh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc02bh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
