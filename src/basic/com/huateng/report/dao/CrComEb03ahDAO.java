...
@Repository
public class CrComEb03ahDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEb03ahDAO.class);

    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrComEb03ah pojo) {
    ...
    public void save(CrComEb03ah pojo) {
    ...
    public void delete(CrComEb03ah pojo) {
    ...
    public CrComEb03ah findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEb03ah)this.getHibernateTemplate().get(CrComEb03ah.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEb03ah> findByProperties(CrComEb03ah pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEb03ah as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEb03ad01())){
                queryString.append(" and model.eb03ad01 = ? ");
                binds.add(pojo.getEb03ad01());
            }
            if(isNotBlankOrNull(pojo.getEb03ad02())){
                queryString.append(" and model.eb03ad02 = ? ");
                binds.add(pojo.getEb03ad02());
            }
            if(isNotBlankOrNull(pojo.getEb03as02())){
                queryString.append(" and model.eb03as02 = ? ");
                binds.add(pojo.getEb03as02());
            }
            if(isNotBlankOrNull(pojo.getEb03aj01())){
                queryString.append(" and model.eb03aj01 = ? ");
                binds.add(pojo.getEb03aj01());
            }
            ...
            return (List<CrComEb03ah>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEb03ah> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEb03ah>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
