...
@Repository
public class CrPerPc02dhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc02dhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc02dh pojo) {
    ...
    public void save(CrPerPc02dh pojo) {
    ...
    public void delete(CrPerPc02dh pojo) {
    ...
    public CrPerPc02dh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc02dh)this.getHibernateTemplate().get(CrPerPc02dh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02dh> findByProperties(CrPerPc02dh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc02dh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc02dd01())){
                queryString.append(" and model.pc02dd01 = ? ");
                binds.add(pojo.getPc02dd01());
            }
            if(isNotBlankOrNull(pojo.getPc02ds02())){
                queryString.append(" and model.pc02ds02 = ? ");
                binds.add(pojo.getPc02ds02());
            }
            if(isNotBlankOrNull(pojo.getPc02ds03())){
                queryString.append(" and model.pc02ds03 = ? ");
                binds.add(pojo.getPc02ds03());
            }
            if(isNotBlankOrNull(pojo.getPc02dj01())){
                queryString.append(" and model.pc02dj01 = ? ");
                binds.add(pojo.getPc02dj01());
            }
            if(isNotBlankOrNull(pojo.getPc02ds04())){
                queryString.append(" and model.pc02ds04 = ? ");
                binds.add(pojo.getPc02ds04());
            }
            ...
            return (List<CrPerPc02dh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02dh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc02dh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
