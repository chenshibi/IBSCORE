...
@Repository
public class CrPerPf07zhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPf07zhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPf07zh pojo) {
    ...
    public void save(CrPerPf07zh pojo) {
    ...
    public void delete(CrPerPf07zh pojo) {
    ...
    public CrPerPf07zh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPf07zh)this.getHibernateTemplate().get(CrPerPf07zh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPf07zh> findByProperties(CrPerPf07zh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPf07zh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPf07zd01())){
                queryString.append(" and model.pf07zd01 = ? ");
                binds.add(pojo.getPf07zd01());
            }
            if(isNotBlankOrNull(pojo.getPf07zq01())){
                queryString.append(" and model.pf07zq01 = ? ");
                binds.add(pojo.getPf07zq01());
            }
            if(isNotBlankOrNull(pojo.getPf07zr01())){
                queryString.append(" and model.pf07zr01 = ? ");
                binds.add(pojo.getPf07zr01());
            }
            ...
            return (List<CrPerPf07zh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPf07zh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPf07zh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
