...
@Repository
public class CrComEbeDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEbeDAO.class);
    ...
    public void update(CrComEbe pojo) {
    ...
    public void save(CrComEbe pojo) {
    ...
    public void delete(CrComEbe pojo) {
    ...
    public CrComEbe findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEbe)this.getHibernateTemplate().get(CrComEbe.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEbe> findByProperties(CrComEbe pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEbe as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getEb05as01())){
                queryString.append(" and model.eb05as01 = ? ");
                binds.add(pojo.getEb05as01());
            }
            if(isNotBlankOrNull(pojo.getEb05bs01())){
                queryString.append(" and model.eb05bs01 = ? ");
                binds.add(pojo.getEb05bs01());
            }
            ...
            return (List<CrComEbe>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEbe> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEbe>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
