...
@Repository
public class CrComEd03DAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEd03DAO.class);
    ...
    public void update(CrComEd03 pojo) {
    ...
    public void save(CrComEd03 pojo) {
    ...
    public void delete(CrComEd03 pojo) {
    ...
    public CrComEd03 findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEd03)this.getHibernateTemplate().get(CrComEd03.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEd03> findByProperties(CrComEd03 pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEd03 as model where 0= 0 ");
            ...
            return (List<CrComEd03>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEd03> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEd03>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
