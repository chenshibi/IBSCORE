...
@Repository
public class CrPerPosDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPosDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPos pojo) {
    ...
    public void save(CrPerPos pojo) {
    ...
    public void delete(CrPerPos pojo) {
    ...
    public CrPerPos findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPos)this.getHibernateTemplate().get(CrPerPos.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPos> findByProperties(CrPerPos pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPos as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getPg010d01())){
                queryString.append(" and model.pg010d01 = ? ");
                binds.add(pojo.getPg010d01());
            }
            if(isNotBlankOrNull(pojo.getPg010d02())){
                queryString.append(" and model.pg010d02 = ? ");
                binds.add(pojo.getPg010d02());
            }
            if(isNotBlankOrNull(pojo.getPg010s01())){
                queryString.append(" and model.pg010s01 = ? ");
                binds.add(pojo.getPg010s01());
            }
            ...
            return (List<CrPerPos>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPos> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPos>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
