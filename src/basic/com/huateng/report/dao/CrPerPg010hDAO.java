...
@Repository
public class CrPerPg010hDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPg010hDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPg010h pojo) {
    ...
    public void save(CrPerPg010h pojo) {
    ...
    public void delete(CrPerPg010h pojo) {
    ...
    public CrPerPg010h findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPg010h)this.getHibernateTemplate().get(CrPerPg010h.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPg010h> findByProperties(CrPerPg010h pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPg010h as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPg010d03())){
                queryString.append(" and model.pg010d03 = ? ");
                binds.add(pojo.getPg010d03());
            }
            if(isNotBlankOrNull(pojo.getPg010q01())){
                queryString.append(" and model.pg010q01 = ? ");
                binds.add(pojo.getPg010q01());
            }
            if(isNotBlankOrNull(pojo.getPg010r01())){
                queryString.append(" and model.pg010r01 = ? ");
                binds.add(pojo.getPg010r01());
            }
            ...
            return (List<CrPerPg010h>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPg010h> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPg010h>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
