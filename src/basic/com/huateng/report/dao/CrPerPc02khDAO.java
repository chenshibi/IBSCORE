...
@Repository
public class CrPerPc02khDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc02khDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc02kh pojo) {
    ...
    public void save(CrPerPc02kh pojo) {
    ...
    public void delete(CrPerPc02kh pojo) {
    ...
    public CrPerPc02kh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc02kh)this.getHibernateTemplate().get(CrPerPc02kh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02kh> findByProperties(CrPerPc02kh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc02kh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc02kd01())){
                queryString.append(" and model.pc02kd01 = ? ");
                binds.add(pojo.getPc02kd01());
            }
            if(isNotBlankOrNull(pojo.getPc02kd02())){
                queryString.append(" and model.pc02kd02 = ? ");
                binds.add(pojo.getPc02kd02());
            }
            if(isNotBlankOrNull(pojo.getPc02ks02())){
                queryString.append(" and model.pc02ks02 = ? ");
                binds.add(pojo.getPc02ks02());
            }
            if(isNotBlankOrNull(pojo.getPc02kj01())){
                queryString.append(" and model.pc02kj01 = ? ");
                binds.add(pojo.getPc02kj01());
            }
            if(isNotBlankOrNull(pojo.getPc02kj02())){
                queryString.append(" and model.pc02kj02 = ? ");
                binds.add(pojo.getPc02kj02());
            }
            ...
            return (List<CrPerPc02kh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02kh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc02kh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
