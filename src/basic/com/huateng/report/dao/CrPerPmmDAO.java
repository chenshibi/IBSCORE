...
@Repository
public class CrPerPmmDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPmmDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPmm pojo) {
    ...
    public void save(CrPerPmm pojo) {
    ...
    public void delete(CrPerPmm pojo) {
    ...
    public CrPerPmm findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPmm)this.getHibernateTemplate().get(CrPerPmm.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPmm> findByProperties(CrPerPmm pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPmm as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getPb020d01())){
                queryString.append(" and model.pb020d01 = ? ");
                binds.add(pojo.getPb020d01());
            }
            if(isNotBlankOrNull(pojo.getPb020q01())){
                queryString.append(" and model.pb020q01 = ? ");
                binds.add(pojo.getPb020q01());
            }
            if(isNotBlankOrNull(pojo.getPb020d02())){
                queryString.append(" and model.pb020d02 = ? ");
                binds.add(pojo.getPb020d02());
            }
            if(isNotBlankOrNull(pojo.getPb020i01())){
                queryString.append(" and model.pb020i01 = ? ");
                binds.add(pojo.getPb020i01());
            }
            if(isNotBlankOrNull(pojo.getPb020q02())){
                queryString.append(" and model.pb020q02 = ? ");
                binds.add(pojo.getPb020q02());
            }
            if(isNotBlankOrNull(pojo.getPb020q03())){
                queryString.append(" and model.pb020q03 = ? ");
                binds.add(pojo.getPb020q03());
            }
            ...
            return (List<CrPerPmm>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPmm> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPmm>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
