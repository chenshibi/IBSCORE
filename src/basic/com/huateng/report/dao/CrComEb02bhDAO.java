...
@Repository
public class CrComEb02bhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEb02bhDAO.class);
    ...
    public void update(CrComEb02bh pojo) {
    ...
    public void save(CrComEb02bh pojo) {
    ...
    public void delete(CrComEb02bh pojo) {
    ...
    public CrComEb02bh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEb02bh)this.getHibernateTemplate().get(CrComEb02bh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEb02bh> findByProperties(CrComEb02bh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEb02bh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEb02bd01())){
                queryString.append(" and model.eb02bd01 = ? ");
                binds.add(pojo.getEb02bd01());
            }
            if(isNotBlankOrNull(pojo.getEb02bd02())){
                queryString.append(" and model.eb02bd02 = ? ");
                binds.add(pojo.getEb02bd02());
            }
            if(isNotBlankOrNull(pojo.getEb02bs04())){
                queryString.append(" and model.eb02bs04 = ? ");
                binds.add(pojo.getEb02bs04());
            }
            ...
            return (List<CrComEb02bh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEb02bh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEb02bh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
