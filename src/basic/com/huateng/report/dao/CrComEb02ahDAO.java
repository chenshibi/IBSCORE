...
@Repository
public class CrComEb02ahDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEb02ahDAO.class);
    ...
    public void update(CrComEb02ah pojo) {
    ...
    public void save(CrComEb02ah pojo) {
    ...
    public void delete(CrComEb02ah pojo) {
    ...
    public CrComEb02ah findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEb02ah)this.getHibernateTemplate().get(CrComEb02ah.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEb02ah> findByProperties(CrComEb02ah pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEb02ah as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEb02ad01())){
                queryString.append(" and model.eb02ad01 = ? ");
                binds.add(pojo.getEb02ad01());
            }
            if(isNotBlankOrNull(pojo.getEb02ad02())){
                queryString.append(" and model.eb02ad02 = ? ");
                binds.add(pojo.getEb02ad02());
            }
            if(isNotBlankOrNull(pojo.getEb02as04())){
                queryString.append(" and model.eb02as04 = ? ");
                binds.add(pojo.getEb02as04());
            }
            if(isNotBlankOrNull(pojo.getEb02aj06())){
                queryString.append(" and model.eb02aj06 = ? ");
                binds.add(pojo.getEb02aj06());
            }
            ...
            return (List<CrComEb02ah>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEb02ah> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEb02ah>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
