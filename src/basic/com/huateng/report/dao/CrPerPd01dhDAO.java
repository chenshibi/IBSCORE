...
@Repository
public class CrPerPd01dhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPd01dhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPd01dh pojo) {
    ...
    public void save(CrPerPd01dh pojo) {
    ...
    public void delete(CrPerPd01dh pojo) {
    ...
    public CrPerPd01dh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPd01dh)this.getHibernateTemplate().get(CrPerPd01dh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01dh> findByProperties(CrPerPd01dh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPd01dh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPd01dr03())){
                queryString.append(" and model.pd01dr03 = ? ");
                binds.add(pojo.getPd01dr03());
            }
            if(isNotBlankOrNull(pojo.getPd01dd01())){
                queryString.append(" and model.pd01dd01 = ? ");
                binds.add(pojo.getPd01dd01());
            }
            ...
            return (List<CrPerPd01dh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01dh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPd01dh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
