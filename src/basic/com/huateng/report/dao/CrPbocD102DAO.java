...
@Repository
public class CrPbocD102DAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPbocD102DAO.class);
    ...
    public void update(CrPbocD102 pojo) {
    ...
    public void save(CrPbocD102 pojo) {
    ...
    public void delete(CrPbocD102 pojo) {
    ...
    public CrPbocD102 findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPbocD102)this.getHibernateTemplate().get(CrPbocD102.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPbocD102> findByProperties(CrPbocD102 pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPbocD102 as model where 0= 0 ");
            ...
            return (List<CrPbocD102>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
