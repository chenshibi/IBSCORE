...
@Repository
public class CrPerPc030hDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc030hDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc030h pojo) {
    ...
    public void save(CrPerPc030h pojo) {
    ...
    public void delete(CrPerPc030h pojo) {
    ...
    public CrPerPc030h findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc030h)this.getHibernateTemplate().get(CrPerPc030h.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc030h> findByProperties(CrPerPc030h pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc030h as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc030d01())){
                queryString.append(" and model.pc030d01 = ? ");
                binds.add(pojo.getPc030d01());
            }
            if(isNotBlankOrNull(pojo.getPc030s02())){
                queryString.append(" and model.pc030s02 = ? ");
                binds.add(pojo.getPc030s02());
            }
            if(isNotBlankOrNull(pojo.getPc030j01())){
                queryString.append(" and model.pc030j01 = ? ");
                binds.add(pojo.getPc030j01());
            }
            ...
            return (List<CrPerPc030h>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc030h> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc030h>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
