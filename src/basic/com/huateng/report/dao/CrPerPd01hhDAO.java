...
@Repository
public class CrPerPd01hhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPd01hhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPd01hh pojo) {
    ...
    public void save(CrPerPd01hh pojo) {
    ...
    public void delete(CrPerPd01hh pojo) {
    ...
    public CrPerPd01hh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPd01hh)this.getHibernateTemplate().get(CrPerPd01hh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01hh> findByProperties(CrPerPd01hh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPd01hh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPd01hj01())){
                queryString.append(" and model.pd01hj01 = ? ");
                binds.add(pojo.getPd01hj01());
            }
            if(isNotBlankOrNull(pojo.getPd01hr01())){
                queryString.append(" and model.pd01hr01 = ? ");
                binds.add(pojo.getPd01hr01());
            }
            if(isNotBlankOrNull(pojo.getPd01hr02())){
                queryString.append(" and model.pd01hr02 = ? ");
                binds.add(pojo.getPd01hr02());
            }
            if(isNotBlankOrNull(pojo.getPd01hj02())){
                queryString.append(" and model.pd01hj02 = ? ");
                binds.add(pojo.getPd01hj02());
            }
            ...
            return (List<CrPerPd01hh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01hh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPd01hh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
