...
@Repository
public class CrComEc050hDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEc050hDAO.class);
    ...
    public void update(CrComEc050h pojo) {
    ...
    public void save(CrComEc050h pojo) {
    ...
    public void delete(CrComEc050h pojo) {
    ...
    public CrComEc050h findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEc050h)this.getHibernateTemplate().get(CrComEc050h.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEc050h> findByProperties(CrComEc050h pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEc050h as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEc050d01())){
                queryString.append(" and model.ec050d01 = ? ");
                binds.add(pojo.getEc050d01());
            }
            if(isNotBlankOrNull(pojo.getEc050q01())){
                queryString.append(" and model.ec050q01 = ? ");
                binds.add(pojo.getEc050q01());
            }
            if(isNotBlankOrNull(pojo.getEc050d02())){
                queryString.append(" and model.ec050d02 = ? ");
                binds.add(pojo.getEc050d02());
            }
            if(isNotBlankOrNull(pojo.getEc050i01())){
                queryString.append(" and model.ec050i01 = ? ");
                binds.add(pojo.getEc050i01());
            }
            ...
            return (List<CrComEc050h>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEc050h> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEc050h>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
