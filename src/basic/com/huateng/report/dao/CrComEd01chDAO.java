...
@Repository
public class CrComEd01chDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEd01chDAO.class);
    ...
    public void update(CrComEd01ch pojo) {
    ...
    public void save(CrComEd01ch pojo) {
    ...
    public void delete(CrComEd01ch pojo) {
    ...
    public CrComEd01ch findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEd01ch)this.getHibernateTemplate().get(CrComEd01ch.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEd01ch> findByProperties(CrComEd01ch pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEd01ch as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEd01cd01())){
                queryString.append(" and model.ed01cd01 = ? ");
                binds.add(pojo.getEd01cd01());
            }
            if(isNotBlankOrNull(pojo.getEd01cr01())){
                queryString.append(" and model.ed01cr01 = ? ");
                binds.add(pojo.getEd01cr01());
            }
            if(isNotBlankOrNull(pojo.getEd01cj01())){
                queryString.append(" and model.ed01cj01 = ? ");
                binds.add(pojo.getEd01cj01());
            }
            if(isNotBlankOrNull(pojo.getEd01cs02())){
                queryString.append(" and model.ed01cs02 = ? ");
                binds.add(pojo.getEd01cs02());
            }
            if(isNotBlankOrNull(pojo.getEd01cq01())){
                queryString.append(" and model.ed01cq01 = ? ");
                binds.add(pojo.getEd01cq01());
            }
            ...
            return (List<CrComEd01ch>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEd01ch> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEd01ch>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
