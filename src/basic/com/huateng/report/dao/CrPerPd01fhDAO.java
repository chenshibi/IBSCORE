...
@Repository
public class CrPerPd01fhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPd01fhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPd01fh pojo) {
    ...
    public void save(CrPerPd01fh pojo) {
    ...
    public void delete(CrPerPd01fh pojo) {
    ...
    public CrPerPd01fh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPd01fh)this.getHibernateTemplate().get(CrPerPd01fh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01fh> findByProperties(CrPerPd01fh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPd01fh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPd01fd01())){
                queryString.append(" and model.pd01fd01 = ? ");
                binds.add(pojo.getPd01fd01());
            }
            if(isNotBlankOrNull(pojo.getPd01fr01())){
                queryString.append(" and model.pd01fr01 = ? ");
                binds.add(pojo.getPd01fr01());
            }
            if(isNotBlankOrNull(pojo.getPd01fs02())){
                queryString.append(" and model.pd01fs02 = ? ");
                binds.add(pojo.getPd01fs02());
            }
            if(isNotBlankOrNull(pojo.getPd01fj01())){
                queryString.append(" and model.pd01fj01 = ? ");
                binds.add(pojo.getPd01fj01());
            }
            if(isNotBlankOrNull(pojo.getPd01fq01())){
                queryString.append(" and model.pd01fq01 = ? ");
                binds.add(pojo.getPd01fq01());
            }
            ...
            return (List<CrPerPd01fh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd01fh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPd01fh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
