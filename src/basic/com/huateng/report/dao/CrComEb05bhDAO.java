...
@Repository
public class CrComEb05bhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEb05bhDAO.class);

    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrComEb05bh pojo) {
    ...
    public void save(CrComEb05bh pojo) {
    ...
    public void delete(CrComEb05bh pojo) {
    ...
    public CrComEb05bh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEb05bh)this.getHibernateTemplate().get(CrComEb05bh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEb05bh> findByProperties(CrComEb05bh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEb05bh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEb05bd01())){
                queryString.append(" and model.eb05bd01 = ? ");
                binds.add(pojo.getEb05bd01());
            }
            if(isNotBlankOrNull(pojo.getEb05bj01())){
                queryString.append(" and model.eb05bj01 = ? ");
                binds.add(pojo.getEb05bj01());
            }
            if(isNotBlankOrNull(pojo.getEb05bs02())){
                queryString.append(" and model.eb05bs02 = ? ");
                binds.add(pojo.getEb05bs02());
            }
            if(isNotBlankOrNull(pojo.getEb05bj02())){
                queryString.append(" and model.eb05bj02 = ? ");
                binds.add(pojo.getEb05bj02());
            }
            if(isNotBlankOrNull(pojo.getEb05bj03())){
                queryString.append(" and model.eb05bj03 = ? ");
                binds.add(pojo.getEb05bj03());
            }
            if(isNotBlankOrNull(pojo.getEb05bj04())){
                queryString.append(" and model.eb05bj04 = ? ");
                binds.add(pojo.getEb05bj04());
            }
            ...
            return (List<CrComEb05bh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEb05bh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEb05bh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
