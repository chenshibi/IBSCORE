...
@Repository
public class CrPerPc040hDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc040hDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc040h pojo) {
    ...
    public void save(CrPerPc040h pojo) {
    ...
    public void delete(CrPerPc040h pojo) {
    ...
    public CrPerPc040h findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc040h)this.getHibernateTemplate().get(CrPerPc040h.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc040h> findByProperties(CrPerPc040h pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc040h as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc040d01())){
                queryString.append(" and model.pc040d01 = ? ");
                binds.add(pojo.getPc040d01());
            }
            if(isNotBlankOrNull(pojo.getPc040s02())){
                queryString.append(" and model.pc040s02 = ? ");
                binds.add(pojo.getPc040s02());
            }
            if(isNotBlankOrNull(pojo.getPc040j01())){
                queryString.append(" and model.pc040j01 = ? ");
                binds.add(pojo.getPc040j01());
            }
            ...
            return (List<CrPerPc040h>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc040h> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc040h>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
