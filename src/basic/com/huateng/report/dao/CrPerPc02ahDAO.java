...
@Repository
public class CrPerPc02ahDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPc02ahDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPc02ah pojo) {
    ...
    public void save(CrPerPc02ah pojo) {
    ...
    public void delete(CrPerPc02ah pojo) {
    ...
    public CrPerPc02ah findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPc02ah)this.getHibernateTemplate().get(CrPerPc02ah.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02ah> findByProperties(CrPerPc02ah pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPc02ah as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPc02ad01())){
                queryString.append(" and model.pc02ad01 = ? ");
                binds.add(pojo.getPc02ad01());
            }
            if(isNotBlankOrNull(pojo.getPc02ad02())){
                queryString.append(" and model.pc02ad02 = ? ");
                binds.add(pojo.getPc02ad02());
            }
            if(isNotBlankOrNull(pojo.getPc02as03())){
                queryString.append(" and model.pc02as03 = ? ");
                binds.add(pojo.getPc02as03());
            }
            if(isNotBlankOrNull(pojo.getPc02ar01())){
                queryString.append(" and model.pc02ar01 = ? ");
                binds.add(pojo.getPc02ar01());
            }
            ...
            return (List<CrPerPc02ah>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPc02ah> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPc02ah>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
