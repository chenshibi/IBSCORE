...
@Repository
public class CrPerPd02zhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPd02zhDAO.class);
    @Resource(name = "mySessionFactory")
    public void setSuperSessionFactory(SessionFactory sessionFactory) {
        super.setSessionFactory(sessionFactory);
    }
    public void update(CrPerPd02zh pojo) {
    ...
    public void save(CrPerPd02zh pojo) {
    ...
    public void delete(CrPerPd02zh pojo) {
    ...
    public CrPerPd02zh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPd02zh)this.getHibernateTemplate().get(CrPerPd02zh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd02zh> findByProperties(CrPerPd02zh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPd02zh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPd02zd01())){
                queryString.append(" and model.pd02zd01 = ? ");
                binds.add(pojo.getPd02zd01());
            }
            if(isNotBlankOrNull(pojo.getPd02zq01())){
                queryString.append(" and model.pd02zq01 = ? ");
                binds.add(pojo.getPd02zq01());
            }
            if(isNotBlankOrNull(pojo.getPd02zr01())){
                queryString.append(" and model.pd02zr01 = ? ");
                binds.add(pojo.getPd02zr01());
            }
            ...
            return (List<CrPerPd02zh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPd02zh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPd02zh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
