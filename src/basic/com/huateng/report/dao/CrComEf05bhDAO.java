...
@Repository
public class CrComEf05bhDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEf05bhDAO.class);
    ...
    public void update(CrComEf05bh pojo) {
    ...
    public void save(CrComEf05bh pojo) {
    ...
    public void delete(CrComEf05bh pojo) {
    ...
    public CrComEf05bh findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEf05bh)this.getHibernateTemplate().get(CrComEf05bh.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEf05bh> findByProperties(CrComEf05bh pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEf05bh as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEf05br01())){
                queryString.append(" and model.ef05br01 = ? ");
                binds.add(pojo.getEf05br01());
            }
            if(isNotBlankOrNull(pojo.getEf05bd01())){
                queryString.append(" and model.ef05bd01 = ? ");
                binds.add(pojo.getEf05bd01());
            }
            if(isNotBlankOrNull(pojo.getEf05bj01())){
                queryString.append(" and model.ef05bj01 = ? ");
                binds.add(pojo.getEf05bj01());
            }
            if(isNotBlankOrNull(pojo.getEf05bj02())){
                queryString.append(" and model.ef05bj02 = ? ");
                binds.add(pojo.getEf05bj02());
            }
            if(isNotBlankOrNull(pojo.getEf05bj03())){
                queryString.append(" and model.ef05bj03 = ? ");
                binds.add(pojo.getEf05bj03());
            }
            ...
            return (List<CrComEf05bh>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEf05bh> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEf05bh>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
