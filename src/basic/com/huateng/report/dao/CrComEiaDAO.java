...
@Repository
public class CrComEiaDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEiaDAO.class);
    ...
    public void update(CrComEia pojo) {
    ...
    public void save(CrComEia pojo) {
    ...
    public void delete(CrComEia pojo) {
    ...
    public CrComEia findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEia)this.getHibernateTemplate().get(CrComEia.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEia> findByProperties(CrComEia pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEia as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getEi010d01())){
                queryString.append(" and model.ei010d01 = ? ");
                binds.add(pojo.getEi010d01());
            }
            if(isNotBlankOrNull(pojo.getEi010i01())){
                queryString.append(" and model.ei010i01 = ? ");
                binds.add(pojo.getEi010i01());
            }
            if(isNotBlankOrNull(pojo.getEi010d02())){
                queryString.append(" and model.ei010d02 = ? ");
                binds.add(pojo.getEi010d02());
            }
            if(isNotBlankOrNull(pojo.getEi010q01())){
                queryString.append(" and model.ei010q01 = ? ");
                binds.add(pojo.getEi010q01());
            }
            if(isNotBlankOrNull(pojo.getEi010r01())){
                queryString.append(" and model.ei010r01 = ? ");
                binds.add(pojo.getEi010r01());
            }
            ...
            return (List<CrComEia>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEia> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEia>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
