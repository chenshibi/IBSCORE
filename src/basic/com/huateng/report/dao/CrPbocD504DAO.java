...
import resource.bean.crms.CrPbocD504;

@Repository
public class CrPbocD504DAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPbocD504DAO.class);
    ...
    public void update(CrPbocD504 pojo) {
    ...
    public void save(CrPbocD504 pojo) {
    ...
    public void delete(CrPbocD504 pojo) {
    ...
    public CrPbocD504 findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPbocD504)this.getHibernateTemplate().get(CrPbocD504.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPbocD504> findByProperties(CrPbocD504 pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPbocD504 as model where 0= 0 ");
            ...
            return (List<CrPbocD504>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
