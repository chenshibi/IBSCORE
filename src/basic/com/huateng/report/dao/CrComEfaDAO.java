...
@Repository
public class CrComEfaDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEfaDAO.class);
    ...
    public void update(CrComEfa pojo) {
    ...
    public void save(CrComEfa pojo) {
    ...
    public void delete(CrComEfa pojo) {
    ...
    public CrComEfa findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEfa)this.getHibernateTemplate().get(CrComEfa.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEfa> findByProperties(CrComEfa pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEfa as model where 0= 0 ");
            List<Object> binds = new ArrayList<Object>();
            if(isNotBlankOrNull(pojo.getId())){
                queryString.append(" and model.id = ? ");
                binds.add(pojo.getId());
            }
            if(isNotBlankOrNull(pojo.getEf010i01())){
                queryString.append(" and model.ef010i01 = ? ");
                binds.add(pojo.getEf010i01());
            }
            if(isNotBlankOrNull(pojo.getEf010q01())){
                queryString.append(" and model.ef010q01 = ? ");
                binds.add(pojo.getEf010q01());
            }
            if(isNotBlankOrNull(pojo.getEf010j01())){
                queryString.append(" and model.ef010j01 = ? ");
                binds.add(pojo.getEf010j01());
            }
            if(isNotBlankOrNull(pojo.getEf010r01())){
                queryString.append(" and model.ef010r01 = ? ");
                binds.add(pojo.getEf010r01());
            }
            ...
            return (List<CrComEfa>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEfa> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEfa>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
