...
@Repository
public class CrPerPa01chDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrPerPa01chDAO.class);
    ...
    public void update(CrPerPa01ch pojo) {
    ...
    public void save(CrPerPa01ch pojo) {
    ...
    public void delete(CrPerPa01ch pojo) {
    ...
    public CrPerPa01ch findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrPerPa01ch)this.getHibernateTemplate().get(CrPerPa01ch.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrPerPa01ch> findByProperties(CrPerPa01ch pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrPerPa01ch as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getPa01cd01())){
                queryString.append(" and model.pa01cd01 = ? ");
                binds.add(pojo.getPa01cd01());
            }
            if(isNotBlankOrNull(pojo.getPa01ci01())){
                queryString.append(" and model.pa01ci01 = ? ");
                binds.add(pojo.getPa01ci01());
            }
            ...
            return (List<CrPerPa01ch>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrPerPa01ch> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrPerPa01ch>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
