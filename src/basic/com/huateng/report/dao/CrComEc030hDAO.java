...
@Repository
public class CrComEc030hDAO extends HibernateDaoSupport {

    private static final Logger log = Logger.getLogger(CrComEc030hDAO.class);
    ...
    public void update(CrComEc030h pojo) {
    ...
    public void save(CrComEc030h pojo) {
    ...
    public void delete(CrComEc030h pojo) {
    ...
    public CrComEc030h findById(java.lang.String id) {
        log.info("getting pojo instance with id: " + id);
        try {
            return (CrComEc030h)this.getHibernateTemplate().get(CrComEc030h.class, id);
        } catch (RuntimeException re) {
    ...
    public List<CrComEc030h> findByProperties(CrComEc030h pojo) {
        log.info("finding pojo instance with properties: " + pojo.toString());
        try {
            StringBuffer queryString = new StringBuffer();
            queryString.append("from CrComEc030h as model where 0= 0 ");
            ...
            if(isNotBlankOrNull(pojo.getEc030q01())){
                queryString.append(" and model.ec030q01 = ? ");
                binds.add(pojo.getEc030q01());
            }
            if(isNotBlankOrNull(pojo.getEc030d01())){
                queryString.append(" and model.ec030d01 = ? ");
                binds.add(pojo.getEc030d01());
            }
            if(isNotBlankOrNull(pojo.getEc030i01())){
                queryString.append(" and model.ec030i01 = ? ");
                binds.add(pojo.getEc030i01());
            }
            if(isNotBlankOrNull(pojo.getEc030d02())){
                queryString.append(" and model.ec030d02 = ? ");
                binds.add(pojo.getEc030d02());
            }
            ...
            return (List<CrComEc030h>)getHibernateTemplate().find(queryString.toString(), binds.toArray());
        } catch (RuntimeException re) {
    ...
    public List<CrComEc030h> findByIdProperties(String ids) {
        ...
        try {
        	...
        	return  (List<CrComEc030h>)getHibernateTemplate().find(queryString.toString(), null);
        } catch (RuntimeException re) {
            log.error("find by properties failed", re);
            throw re;
        }
