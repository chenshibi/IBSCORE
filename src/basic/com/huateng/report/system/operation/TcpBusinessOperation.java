 ...
 * 系统参数操作类
 */
public class TcpBusinessOperation extends BaseOperation {
    private static Logger log = Logger.getLogger(TcpBusinessOperation.class);
    public final static String ID = "tcpBusinessOperation";
    ...
    public void execute(OperationContext context) throws CommonException {
        ...
        if (CMD_MOD.equals(cmd)) {
            ...
            try {
                ...
                SysTaskInfo taskInfo = ReportTaskUtil.getSysTaskInfoBean(
                        ReportEnum.REPORT_TASK_FUNCID.TASK_120399.value, ReportEnum.REPORT_TASK_TRANS_CD.EDIT.value,
        ...
        gi.addBizLog("Updater.log", new String[] { gi.getTlrno(),  "执行更新电信参数信息" });
        log.info(gi.getBrcode() + " " + gi.getTlrno() + " 执行更新电信参数信息");
    }
