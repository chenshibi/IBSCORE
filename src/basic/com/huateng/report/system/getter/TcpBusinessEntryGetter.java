...
import com.huateng.report.system.service.TcpBusinessService;

public class TcpBusinessEntryGetter extends BaseGetter {
    /*
     * 获取系统参数列表
     * 
     * @author zhuhongyong
    ...
    private PageQueryResult getData() {
        ...
        return TcpBusinessService.getInstance().pageQueryByHql(pageIndex, pageSize, paramgroupId, qst);
    }
}
