...
import com.huateng.report.system.operation.TcpBusinessOperation;
 ...
 * 
 */
public class TcpBusinessModUpdate extends BaseUpdate {

    private static final String DATASET_ID = "tcpBusinessEntry";
    ...
    public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
        ...
        try {
            ...
            if (updateResultBean.hasNext()) {
                ...
                context.setAttribute(TcpBusinessOperation.CMD, TcpBusinessOperation.CMD_MOD);
                ...
                context.setAttribute(TcpBusinessOperation.IN_PARAM, sysParams);
                // call方式开启operation事务
                OPCaller.call(TcpBusinessOperation.ID, context);
