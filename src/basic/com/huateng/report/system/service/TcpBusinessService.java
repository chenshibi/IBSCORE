...
public class TcpBusinessService {
    private static final HtLog htlog = HtLogFactory.getLogger(TcpBusinessService.class);

    /*
     * 获得自身的实例
     *
     */
    public static synchronized TcpBusinessService getInstance() {
        return (TcpBusinessService) ApplicationContextUtils.getBean("tcpBusinessService");
    }
    ...
    public PageQueryResult pageQueryByHql(int pageIndex, int maxRows, String paramgroupId, String qst) {
        ...
        String hql = "from SysParams sysParams where sysParams.del='F' and sysParams.sys_name='TCP'";
    ...
    public PageQueryResult paramgroupIdSelect(int pageIndex, int pageSize, String paramgroupId) {
        String hql = "from SysParams sysParams where sysParams.sys_name = 'TCP' ";
