...
@Service
public class PersonalDataExtractionExcelService {

	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(PersonalDataExtractionExcelService.class);

	public static PersonalDataExtractionExcelService getInstance() {
		return ApplicationContextUtils.getBean(PersonalDataExtractionExcelService.class);
	}
	
	public void excelPerPrhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		String fileName = currentTime+"_"+"CR_PER_PRH.xlsx";
		
		try {
			List<CrPerPrh> crPerPrhList = BaseDAOUtils.getCrPerPrhDAO().findByIdProperties(id);
			createcrPerPrhExcel(filepath,sheetName,title,fileName,crPerPrhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createcrPerPrhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPa01chExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PA01CH.xlsx";
		
		try {
			List<CrPerPa01ch> crPerPa01chList = BaseDAOUtils.getCrPerPa01chDAO().findByIdProperties(id);
			createCrPerPa01chExcel(filepath,sheetName,title,fileName,crPerPa01chList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPa01chExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPoqExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-报告头-其他身份标识信息段-身份信息";
		// 标题
		String[] title = new String[] { "序号      " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_POQ.xlsx";
		
		try {
			List<CrPerPoq> crPerPoqList = BaseDAOUtils.getCrPerPoqDAO().findByIdProperties(id);
			createCrPerPoqExcel(filepath,sheetName,title,fileName,crPerPoqList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPoqExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPqoExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-报告头-其他身份标识信息段-身份信息";
		// 标题
		String[] title = new String[] {"  序号                                        "   ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PQO.xlsx";
		
		try {
			List<CrPerPqo> crPerPqoList = BaseDAOUtils.getCrPerPqoDAO().findByIdProperties(id);
			createCrPerPqoExcel(filepath,sheetName,title,fileName,crPerPqoList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPqoExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPbsExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PBS.xlsx";
		
		try {
			List<CrPerPbs> crPerPbsList = BaseDAOUtils.getCrPerPbsDAO().findByIdProperties(id);
			createCrPerPbsExcel(filepath,sheetName,title,fileName,crPerPbsList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPbsExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf06zhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF06ZH.xlsx";
		
		try {
			List<CrPerPf06zh> crPerPf06zhlist = BaseDAOUtils.getCrPerPf06zhDAO().findByIdProperties(id);
			createCrPerPf06zhExcel(filepath,sheetName,title,fileName,crPerPf06zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPf06zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPnoExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PNO.xlsx";
		
		try {
			List<CrPerPno> crPerPnolist = BaseDAOUtils.getCrPerPnoDAO().findByIdProperties(id);
			createCrPerPnoExcel(filepath,sheetName,title,fileName,crPerPnolist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPnoExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc03ohExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC030H.xlsx";
		
		try {
			List<CrPerPc030h> crPerPc03Ohlist = BaseDAOUtils.getCrPerPc030hDAO().findByIdProperties(id);
			createCrPerPc03OhExcel(filepath,sheetName,title,fileName,crPerPc03Ohlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPc03OhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPpoExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-非信贷交易信息概要-后付费业务欠费信息汇总信息单元段\r\n" + 
				"-后付费业务欠费信息汇总信息";
		// 标题
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PPO.xlsx";
		
		try {
			List<CrPerPpo> crPerPpolist = BaseDAOUtils.getCrPerPpoDAO().findByIdProperties(id);
			createCrPerPpoExcel(filepath,sheetName,title,fileName,crPerPpolist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPpoExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc04ohExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC040H.xlsx";
		
		try {
			List<CrPerPc040h> crPerPc04Ohlist = BaseDAOUtils.getCrPerPc040hDAO().findByIdProperties(id);
			createCrPerPc040hExcel(filepath,sheetName,title,fileName,crPerPc04Ohlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPc040hExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPapExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-公共信息概要-公共信息概要信息单元段\r\n" + 
				"-公共信息概要信息";
		// 标题
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PAP.xlsx";
		
		try {
			List<CrPerPap> crPerPaplist = BaseDAOUtils.getCrPerPapDAO().findByIdProperties(id);
			createCrPerPapExcel(filepath,sheetName,title,fileName,crPerPaplist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPapExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf04zhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF04ZH.xlsx";
		
		try {
			List<CrPerPf04zh> crPerPf04zhlist = BaseDAOUtils.getCrPerPf04zhDAO().findByIdProperties(id);
			createCrPerPf04zhExcel(filepath,sheetName,title,fileName,crPerPf04zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPf04zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPahExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-行政处罚记录-标注及声明信息段-标注及声明信息";
		// 标题
		String[] title = new String[] { " 序号             " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PAH.xlsx";
		
		try {
			List<CrPerPah> crPerPahlist = BaseDAOUtils.getCrPerPahDAO().findByIdProperties(id);
			createCrPerPahExcel(filepath,sheetName,title,fileName,crPerPahlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPahExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPapExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-行政处罚记录-标注及声明信息段-标注及声明信息";
		// 标题
		String[] title = new String[] { " 序号             " ,
	...
	public void excelCrPahExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-行政处罚记录-标注及声明信息段-标注及声明信息";
		// 标题
		String[] title = new String[] { " 序号             " ,
	...
	public void excelCrPf08zhExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-行政处罚记录-标注及声明信息段-标注及声明信息";
		// 标题
		String[] title = new String[] { " 序号             " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF08ZH.xlsx";
		
		try {
			List<CrPerPf08zh> crPerPf08zhlist = BaseDAOUtils.getCrPerPf08zhDAO().findByIdProperties(id);
			createCrPerPf08zhExcel(filepath,sheetName,title,fileName,crPerPf08zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPf08zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPg01OhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PG010H.xlsx";
		
		try {
			List<CrPerPg010h> crPerPg010hlist = BaseDAOUtils.getCrPerPg010hDAO().findByIdProperties(id);
			createCrPerPg010hExcel(filepath,sheetName,title,fileName,crPerPg010hlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPg010hExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPndExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PND.xlsx";
		
		try {
			List<CrPerPnd> crPerPndlist = BaseDAOUtils.getCrPerPndDAO().findByIdProperties(id);
			createCrPerPndExcel(filepath,sheetName,title,fileName,crPerPndlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPndExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPe01zhExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-后付费业务信息";
		// 标题
		String[] title = new String[] {" 序号                    "  ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PE01ZH.xlsx";
		
		try {
			List<CrPerPe01zh> crPerPe01zhlist = BaseDAOUtils.getCrPerPe01zhDAO().findByIdProperties(id);
			createCrPerPe01zhExcel(filepath,sheetName,title,fileName,crPerPe01zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPe01zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf01zhExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-后付费业务信息";
		// 标题
		String[] title = new String[] {" 序号                    "  ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF01ZH.xlsx";
		
		try {
			List<CrPerPf01zh> crPerPe01zhlist = BaseDAOUtils.getCrPerPf01zhDAO().findByIdProperties(id);
			createCrPerPf01zhExcel(filepath,sheetName,title,fileName,crPerPe01zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPf01zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPmmExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PMM.xlsx";
		
		try {
			List<CrPerPmm> crPerPmmlist = BaseDAOUtils.getCrPerPmmDAO().findByIdProperties(id);
			createCrPerPmmExcel(filepath,sheetName,title,fileName,crPerPmmlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPmmExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPdaExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-婚姻信息";
		// 标题
		String[] title = new String[] {"序号                                               " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PDA.xlsx";
		
		try {
			List<CrPerPda> crPerPdalist = BaseDAOUtils.getCrPerPdaDAO().findByIdProperties(id);
			createCrPdaPmmExcel(filepath,sheetName,title,fileName,crPerPdalist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPdaPmmExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01zhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01ZH.xlsx";
		
		try {
			List<CrPerPd01zh> crPerPmmlist = BaseDAOUtils.getCrPerPd01zhDAO().findByIdProperties(id);
			createCrPerPd01zhExcel(filepath,sheetName,title,fileName,crPerPmmlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPd01zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01hhExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01HH.xlsx";
		
		try {
			List<CrPerPd01hh> crPerPd01hhlist = BaseDAOUtils.getCrPerPd01hhDAO().findByIdProperties(id);
			createCrPerPd01hhExcel(filepath,sheetName,title,fileName,crPerPd01hhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPd01hhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01fhExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-借贷账户信息-大额专项分期信息段-大额专项分期信息";
		// 标题
		String[] title = new String[] {"序号            ", 
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01FH.xlsx";
		
		try {
			List<CrPerPd01fh> crPerPd01fhlist = BaseDAOUtils.getCrPerPd01fhDAO().findByIdProperties(id);
			createCrPerPd01fhExcel(filepath,sheetName,title,fileName,crPerPd01fhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPd01fhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01ghExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01GH.xlsx";
		
		try {
			List<CrPerPd01gh> crPerPd01ghlist = BaseDAOUtils.getCrPerPd01ghDAO().findByIdProperties(id);
			createCrPerPd01ghExcel(filepath,sheetName,title,fileName,crPerPd01ghlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPd01ghExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01dhExcel(String filepath,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询个人征信结果-借贷账户信息-最近24个月还款记录信息段-还款状态信息";
		// 标题
		String[] title = new String[] {"序号","序号","月份","还款状态"};
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01DH.xlsx";
		
		try {
			List<CrPerPd01dh> crPerPd01dhlist = BaseDAOUtils.getCrPerPd01dhDAO().findByIdProperties(id);
			createCrPerPd01dhExcel(filepath,sheetName,title,fileName,crPerPd01dhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPd01dhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd01ehExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD01EH.xlsx";
		
		try {
			List<CrPerPd01eh> crPerPd01ehlist = BaseDAOUtils.getCrPerPd01ehDAO().findByIdProperties(id);
			createCrPerPd01ehExcel(filepath,sheetName,title,fileName,crPerPd01ehlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPd01ehExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPrmExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PRM.xlsx";
		
		try {
			List<CrPerPrm> crPerPrmlist = BaseDAOUtils.getCrPerPrmDAO().findByIdProperties(id);
			createCrPerPrmExcel(filepath,sheetName,title,fileName,crPerPrmlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPrmExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPcjExcel(String filepath,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PCJ.xlsx";
		
		try {
			List<CrPerPcj> crPerPcjlist = BaseDAOUtils.getCrPerPcjDAO().findByIdProperties(id);
			createCrPerPcjExcel(filepath,sheetName,title,fileName,crPerPcjlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPcjExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf02zhExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-民事判决记录";
		// 标题
		String[] title = new String[] {"序号                " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF02ZH.xlsx";
		
		try {
			List<CrPerPf02zh> crPerPf02zhlist = BaseDAOUtils.getCrPerPf02zhDAO().findByIdProperties(id);
			createCrPerPf02zhExcel(filepath,sheetName,title,fileName,crPerPf02zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPf02zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPsmExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PSM.xlsx";
		
		try {
			List<CrPerPsm> crPerPsmlist = BaseDAOUtils.getCrPerPsmDAO().findByIdProperties(id);
			createCrPerPsmExcel(filepath,sheetName,title,fileName,crPerPsmlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPsmExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPosExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_POS.xlsx";
		
		try {
			List<CrPerPos> crPerPoslist = BaseDAOUtils.getCrPerPosDAO().findByIdProperties(id);
			createCrPerPosExcel(filepath,sheetName,title,fileName,crPerPoslist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPosExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPotExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_POT.xlsx";
		
		try {
			List<CrPerPot> crPerPotlist = BaseDAOUtils.getCrPerPotDAO().findByIdProperties(id);
			createCrPerPotExcel(filepath,sheetName,title,fileName,crPerPotlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPotExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPceExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-欠税记录";
		// 标题
		String[] title = new String[] {"序号               " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PCE.xlsx";
		
		try {
			List<CrPerPce> crPerPcelist = BaseDAOUtils.getCrPerPceDAO().findByIdProperties(id);
			createCrPerPceExcel(filepath,sheetName,title,fileName,crPerPcelist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPceExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf03zhExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-欠税记录";
		// 标题
		String[] title = new String[] {"序号               " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF03ZH.xlsx";
		
		try {
			List<CrPerPf03zh> crPerPf03zhlist = BaseDAOUtils.getCrPerPf03zhDAO().findByIdProperties(id);
			createCrPerPf03zhExcel(filepath,sheetName,title,fileName,crPerPf03zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPf03zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPimExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PIM.xlsx";
		
		try {
			List<CrPerPim> crPerPimlist = BaseDAOUtils.getCrPerPimDAO().findByIdProperties(id);
			createCrPerPimExcel(filepath,sheetName,title,fileName,crPerPimlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPimExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPb01bhExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-身份信息";
		// 标题
		String[] title = new String[] {"序号         " , 
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PB01BH.xlsx";
		
		try {
			List<CrPerPb01bh> crPerPb01bhlist = BaseDAOUtils.getCrPerPb01bhDAO().findByIdProperties(id);
			createCrPerPb01bhExcel(filepath,sheetName,title,fileName,crPerPb01bhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPb01bhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPcaExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-身份信息";
		// 标题
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PCA.xlsx";
		
		try {
			List<CrPerPca> crPerPcalist = BaseDAOUtils.getCrPerPcaDAO().findByIdProperties(id);
			createCrPerPcaExcel(filepath,sheetName,title,fileName,crPerPcalist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPcaExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd02zhExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD02ZH.xlsx";
		
		try {
			List<CrPerPd02zh> crPerPd02zhlist = BaseDAOUtils.getCrPerPd02zhDAO().findByIdProperties(id);
			createCrPerPd02zhExcel(filepath,sheetName,title,fileName,crPerPd02zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPd02zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPcrExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PCR.xlsx";
		
		try {
			List<CrPerPcr> crPerPcrlist = BaseDAOUtils.getCrPerPcrDAO().findByIdProperties(id);
			createCrPerPcrExcel(filepath,sheetName,title,fileName,crPerPcrlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPcrExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPd03zhExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PD03ZH.xlsx";
		
		try {
			List<CrPerPd03zh> crPerPd03zhlist = BaseDAOUtils.getCrPerPd03zhDAO().findByIdProperties(id);
			createCrPerPd03zhExcel(filepath,sheetName,title,fileName,crPerPd03zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPd03zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPcoExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PCO.xlsx";
		
		try {
			List<CrPerPco> crPerPcolist = BaseDAOUtils.getCrPerPcoDAO().findByIdProperties(id);
			createCrPerPcoExcel(filepath,sheetName,title,fileName,crPerPcolist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPcoExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc02bhExcel(String filepath,String id) throws IOException{
		// sheet名
		String sheetName = "征信查询个人征信结果-欠税记录";
		// 标题
		String[] title = new String[] {"序号               " ,
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC02BH.xlsx";
		
		try {
			List<CrPerPc02bh> crPerPc02bhlist = BaseDAOUtils.getCrPerPc02bhDAO().findByIdProperties(id);
			createCrPerPc02bhExcel(filepath,sheetName,title,fileName,crPerPc02bhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPc02bhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc02khExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC02KH.xlsx";
		
		try {
			List<CrPerPc02kh> crPerPc02khlist = BaseDAOUtils.getCrPerPc02khDAO().findByIdProperties(id);
			createCrPerPc02khExcel(filepath,sheetName,title,fileName,crPerPc02khlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPc02khExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc02ahExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC02AH.xlsx";
		
		try {
			List<CrPerPc02ah> crPerPc02ahlist = BaseDAOUtils.getCrPerPc02ahDAO().findByIdProperties(id);
			createCrPerPc02ahExcel(filepath,sheetName,title,fileName,crPerPc02ahlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPc02ahExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPc02dhExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PC02DH.xlsx";
		
		try {
			List<CrPerPc02dh> crPerPc02dhlist = BaseDAOUtils.getCrPerPc02dhDAO().findByIdProperties(id);
			createCrPerPc02dhExcel(filepath,sheetName,title,fileName,crPerPc02dhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPc02dhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPpqExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PPQ.xlsx";
		
		try {
			List<CrPerPpq> crPerPpqlist = BaseDAOUtils.getCrPerPpqDAO().findByIdProperties(id);
			createCrPerPpqExcel(filepath,sheetName,title,fileName,crPerPpqlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPpqExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf07zhExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF07ZH.xlsx";
		
		try {
			List<CrPerPf07zh> crPerPf07zhlist = BaseDAOUtils.getCrPerPf07zhDAO().findByIdProperties(id);
			createCrPerPf07zhExcel(filepath,sheetName,title,fileName,crPerPf07zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPf07zhExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPomExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_POM.xlsx";
		
		try {
			List<CrPerPom> crPerPomlist = BaseDAOUtils.getCrPerPomDAO().findByIdProperties(id);
			createCrPerPomExcel(filepath,sheetName,title,fileName,crPerPomlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void createCrPerPomExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPhfExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PHF.xlsx";
		
		try {
			List<CrPerPhf> crPerPhflist = BaseDAOUtils.getCrPerPhfDAO().findByIdProperties(id);
			createCrPerPhfExcel(filepath,sheetName,title,fileName,crPerPhflist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPhfExcel(String filepath, String sheetName, String title[], String fileName,
	...
	public void excelCrPerPf05zhExcel(String filepath,String id) throws IOException{
		// sheet名
		...
		// 文件名
		String currentTime = DataMyUtil.getFullDateTime();
		String fileName = currentTime+"_"+"CR_PER_PF05ZH.xlsx";
		
		try {
			List<CrPerPf05zh> crPerPf05zhlist = BaseDAOUtils.getCrPerPf05zhDAO().findByIdProperties(id);
			createCrPerPf05zhExcel(filepath,sheetName,title,fileName,crPerPf05zhlist);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrPerPf05zhExcel(String filepath, String sheetName, String title[], String fileName,
