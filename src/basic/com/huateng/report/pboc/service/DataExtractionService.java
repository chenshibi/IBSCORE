...
public class DataExtractionService {
	...
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(DataExtractionService.class);

	public static DataExtractionService getInstance() {
		return ApplicationContextUtils.getBean(DataExtractionService.class);
	}

	public void excelCrComEaaExport(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EAA.xlsx";
		try {
			List<CrComEaa> crComEaaList = BaseDAOUtils.getCrComEaaDAO().findByIdProperties(id);
			createCrComEaaExcel(response, sheetName, title, fileName, crComEaaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void excelCrComEaaWrite(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-报告头";
		// 标题
		String[] title = new String[] { "序号", "报告编号", "报告生成时间", "查询机构代码", "查询原因", "企业名称", "企业身份标识个数", "异议标注数目",
	...
	//	filepath=filepath+fileName;
		try {
			List<CrComEaa> crComEaaList = BaseDAOUtils.getCrComEaaDAO().findByIdProperties(id);
			createCrComEaaWrite(sheetName, title, fileName, crComEaaList,response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void excelCrComEa01ChExport(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-报告头-身份标识信息段-企业身份信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "企业身份标识类型", "企业身份标识号码" };
		// 文件名
		String fileName = "CR_COM_EA01CH.xlsx";

		try {
			List<CrComEa01ch> crComEa01chList = BaseDAOUtils.getCrComEa01chDao().findByIdProperties(id);
			createCrComEa01ChExcel(response, sheetName, title, fileName, crComEa01chList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

/*	public void excelCrComEcaExport(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-基本概况信息";
		// 标题
		String[] title = new String[] { "序号", "经济类型", "组织机构类型", "企业身份标识号码" };
		// 文件名
		String fileName = "CR_COM_ECA.xlsx";
	...
	public void excelCrComEca(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-基本概况信息";
		// 标题
		...
		try {
			...
			createCrComEcaExcel(response, sheetName, title, fileName, crComEcaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEc02oh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-注册资本及主要出资人信息-出资人信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "出资人类型", "出资人身份类别", "出资人名称", "出资人身份标识类型", "出资人身份标识号码", "出资比例" };
		// 文件名
		String fileName = "CR_COM_EC020H.xlsx";

		try {
			List<CrComEc020h> crComEc02OhList = BaseDAOUtils.getCrComEc020hDAO().findByIdProperties(id);
			createCrComEc02OhExcel(response, sheetName, title, fileName, crComEc02OhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEc03oh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-主要组成人员信息-主要组成人员信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "姓名", "证件类型", "证件号码", "职位" };
		// 文件名
		String fileName = "CR_COM_EC030H.xlsx";

		try {
			List<CrComEc030h> crComEc02OhList = BaseDAOUtils.getCrComEc030hDAO().findByIdProperties(id);
			createCrComEc03OhExcel(response, sheetName, title, fileName, crComEc02OhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEc05oh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-实际控制人信息-实际控制人信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "实际控制人身份类型", "实际控制人名称", "实际控制人身份标识类型", "实际控制人身份标识号码" };
		// 文件名
		String fileName = "CR_COM_EC050H.xlsx";

		try {
			List<CrComEc050h> crComEc02OhList = BaseDAOUtils.getCrComEc050hDAO().findByIdProperties(id);
			createCrComEc05OhExcel(response, sheetName, title, fileName, crComEc02OhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEba(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EBA.xlsx";

		try {
			List<CrComEba> crComEbaList = BaseDAOUtils.getCrComEbaDAO().findByIdProperties(id);
			createCrComEbaExcel(response, sheetName, title, fileName, crComEbaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEbb(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "未结清借贷交易汇总资产处置业务账户数", "未结清借贷交易汇总资产处置业务余额", "未结清借贷交易汇总最近一次处置日期",
				...
				"负债历史汇总月份数" };
		// 文件名
		String fileName = "CR_COM_EBB.xlsx";
		try {
			List<CrComEbb> crComEbbList = BaseDAOUtils.getCrComEbbDAO().findByIdProperties(id);
			createCrComEbbExcel(response, sheetName, title, fileName, crComEbbList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void excelCrComEb02ah(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-借贷交易汇总信息-未结清借贷交易汇总信息段-其他借贷交易分类汇总信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "业务类型", "资产质量分类", "账户数", "余额" };
		// 文件名
		String fileName = "CR_COM_EB02AH.xlsx";

		try {
			List<CrComEb02ah> crComEb02ahList = BaseDAOUtils.getCrComEb02ahDAO().findByIdProperties(id);
			createCrComEb02ahExcel(response, sheetName, title, fileName, crComEb02ahList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb02ahExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEb02bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-借贷交易汇总信息-已结清借贷交易汇总信息段-其他借贷交易分类汇总信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "业务类型", "资产质量分类", "账户数", "余额" };
		// 文件名
		String fileName = "CR_COM_EB02BH.xlsx";

		try {
			List<CrComEb02bh> crComEb02bhList = BaseDAOUtils.getCrComEb02bhDAO().findByIdProperties(id);
			createCrComEb02bhExcel(response, sheetName, title, fileName, crComEb02bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb02bhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEb02ch(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EB02CH.xlsx";

		try {
			List<CrComEb02ch> crComEb02chList = BaseDAOUtils.getCrComEb02chDAO().findByIdProperties(id);
			createCrComEb02chExcel(response, sheetName, title, fileName, crComEb02chList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb02chExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	 ...
	 */
	public void createCrComEbcExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEb03ah(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-担保交易汇总信息-未结清担保交易汇总信息段-未结清担保交易汇总信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "业务类型", "资产质量分类", "账户数", "余额" };
		// 文件名
		String fileName = "CR_COM_EB03AH.xlsx";

		try {
			List<CrComEb03ah> crComEb03ahList = BaseDAOUtils.getCrComEb03ahDAO().findByIdProperties(id);
			createCrComEb03ahExcel(response, sheetName, title, fileName, crComEb03ahList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb03ahExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEb03bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-担保交易汇总信息-已结清担保交易汇总信息段-已结清担保交易汇总信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "业务类型", "资产质量分类", "账户数" };
		// 文件名
		String fileName = "CR_COM_EB03BH.xlsx";

		try {
			List<CrComEb03bh> crComEb03bhList = BaseDAOUtils.getCrComEb03bhDAO().findByIdProperties(id);
			createCrComEb03bhExcel(response, sheetName, title, fileName, crComEb03bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb03bhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEbd(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "非循环信用额度合计", "已使用的非循环信用额度合计", "剩余可用的非循环额度合计", "循环信用额度合计", "已使用的循环信用额度合计",
				"剩余可用的循环额度合计", "是否包含授信限" };
		// 文件名
		String fileName = "CR_COM_EBD.xlsx";

		try {
			List<CrComEbd> crComEbdList = BaseDAOUtils.getCrComEbdDAO().findByIdProperties(id);
			createCrComEbdExcel(response, sheetName, title, fileName, crComEbdList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEbdExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEbe(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-相关还款责任汇总信息";
		// 标题
		String[] title = new String[] { "序号", "借贷交易相关还款责任类型数量", "担保交易相关还款责任类型数量" };
		// 文件名
		String fileName = "CR_COM_EBE.xlsx";

		try {
			List<CrComEbe> crComEbeList = BaseDAOUtils.getCrComEbeDAO().findByIdProperties(id);
			createCrComEbeExcel(response, sheetName, title, fileName, crComEbeList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEbeExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEb05ah(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-相关还款责任汇总信息";
		// 标题
		...
		// 文件名
		String fileName = "CR_COM_EB05AH.xlsx";

		try {
			List<CrComEb05ah> crComEb05ahList = BaseDAOUtils.getCrComEb05ahDAO().findByIdProperties(id);
			createCrComEb05ahExcel(response, sheetName, title, fileName, crComEb05ahList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb05ahExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEb05bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-相关还款责任汇总信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "责任类型", "还款责任金额", "账户数", "余额", "关注类余额", "不良类余额" };
		// 文件名
		String fileName = "CR_COM_EB05BH.xlsx";

		try {
			List<CrComEb05bh> crComEb05bhList = BaseDAOUtils.getCrComEb05bhDAO().findByIdProperties(id);
			createCrComEb05bhExcel(response, sheetName, title, fileName, crComEb05bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEb05bhExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEda(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EDA.xlsx";

		try {
			List<CrComEda> crComEdaList = BaseDAOUtils.getCrComEdaDAO().findByIdProperties(id);
			createCrComEdaExcel(response, sheetName, title, fileName, crComEdaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEdaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEd01(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-借贷账户信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "借贷账户编号", "账户活动状态", "借贷账户类型", "借款期限", "基本信息段业务管理机构类型",
				...
				"基本信息段信息报告日期" };
		// 文件名
		String fileName = "CR_COM_ED01.xlsx";

		try {
			List<CrComEd01> crComEd01List = BaseDAOUtils.getCrComEd01DAO().findByIdProperties(id);
			createCrComEd01Excel(response, sheetName, title, fileName, crComEd01List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd01Excel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd02(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_ED02.xlsx";

		try {
			List<CrComEd02> crComEd02List = BaseDAOUtils.getCrComEd02DAO().findByIdProperties(id);
			createCrComEd02Excel(response, sheetName, title, fileName, crComEd02List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd02Excel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEd03(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "序号", "借贷账户编号", "贴现账户分机构汇总信息编号", "贴现账户分机构汇总业务管理机构类型", "贴现账户分机构汇总业务管理机构代码",
				...
				"贴现账户分机构汇总逾期本金合计", "贴现账户分机构汇总已结清账户数", "贴现账户分机构汇总已结清账户贴现金额合计" };
		// 文件名
		String fileName = "CR_COM_ED03.xlsx";

		try {
			List<CrComEd03> crComEd03List = BaseDAOUtils.getCrComEd03DAO().findByIdProperties(id);
			createCrComEd03Excel(response, sheetName, title, fileName, crComEd03List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd03Excel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd01b(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-欠息信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "还款表现记录条数", "CR_COM_ED01表ID"};
		// 文件名
		String fileName = "CR_COM_ED01B.xlsx";
		try {
			List<CrComEd01b> crComEd01bList = BaseDAOUtils.getCrComEd01bDAO().findByIdProperties(id);
			createCrComEd01bExcel(response, sheetName, title, fileName, crComEd01bList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrComEd01bExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd01c(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-欠息信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "特定交易个数", "CR_COM_ED01表ID"};
		// 文件名
		String fileName = "CR_COM_ED01C.xlsx";
		try {
			List<CrComEd01c> crComEd01cList = BaseDAOUtils.getCrComEd01cDAO().findByIdProperties(id);
			createCrComEd01cExcel(response, sheetName, title, fileName, crComEd01cList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void createCrComEd01cExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd01bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-借贷账户信息";
		// 标题
		...
		// 文件名
		String fileName = "CR_COM_ED01BH.xlsx";

		try {
			List<CrComEd01bh> crComEd01bhList = BaseDAOUtils.getCrComEd01bhDAO().findByIdProperties(id);
			createCrComEd01bhExcel(response, sheetName, title, fileName, crComEd01bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	/* public void createCrComEd01bhExcel(HttpServletResponse response, String sheetName, String[] title, String fileName, List<CrComEd01bh> crComEd01bhList)
	  {
	    logger.info("start create excel-->");
	    long start=System.currentTimeMillis();
		logger.info("==========="+"start time :"+start+"(ms)");
	    String[][] values = new String[crComEd01bhList.size()][];
	    for (int i = 0; i < crComEd01bhList.size(); i++) {
	      values[i] = new String[title.length];

	      CrComEd01bh crComEd01bh = (CrComEd01bh)crComEd01bhList.get(i);
	...
	*/
	...
	public void createCrComEd01bhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd01ch(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-借贷账户信息-特定交易信息段-特定交易信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "交易类型", "交易日期", "交易金额", "到期日期变更月数", "交易明细信息" };
		// 文件名
		String fileName = "CR_COM_ED01CH.xlsx";

		try {
			List<CrComEd01ch> crComEd01chList = BaseDAOUtils.getCrComEd01chDAO().findByIdProperties(id);
			createCrComEd01chExcel(response, sheetName, title, fileName, crComEd01chList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd01chExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEdb(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EDB.xlsx";

		try {
			List<CrComEdb> crComEdbList = BaseDAOUtils.getCrComEdbDAO().findByIdProperties(id);
			createCrComEdbExcel(response, sheetName, title, fileName, crComEdbList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEdbExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEdb04(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-担保账户信息";
		// 标题
		...
		// 文件名
		String fileName = "CR_COM_ED04.xlsx";

		try {
			List<CrComEd04> crComEdb04List = BaseDAOUtils.getCrComEd04DAO().findByIdProperties(id);
			createCrComEdb04Excel(response, sheetName, title, fileName, crComEdb04List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEdb04Excel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd04b(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-担保账户信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "序号", "信息报告日期", "账户活动状态", "余额", "五级分类", "风险敞口", "代偿（垫款）标志",
				"共同债务标识", "关闭日期" };
		// 文件名
		String fileName = "CR_COM_ED04b.xlsx";

		try {
			List<CrComEd04b> crComEdb04bList = BaseDAOUtils.getCrComEd04bDAO().findByIdProperties(id);
			createCrComEd04bExcel(response, sheetName, title, fileName, crComEdb04bList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd04bExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd05(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "序号", "担保账户分机构汇总信息编号", "担保账户分机构汇总信息业务管理机构类型", "担保账户分机构汇总信息业务管理机构代码",
				...
				"担保账户分机构汇总信息已结清账户数", "担保账户分机构汇总信息垫款标志" };
		// 文件名
		String fileName = "CR_COM_ED05.xlsx";

		try {
			List<CrComEd05> crComEdb05List = BaseDAOUtils.getCrComEd05DAO().findByIdProperties(id);
			createCrComEd05Excel(response, sheetName, title, fileName, crComEdb05List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd05Excel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEdc(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EDC.xlsx";

		try {
			List<CrComEdc> crComEdcList = BaseDAOUtils.getCrComEdcDAO().findByIdProperties(id);
			createCrComEdcExcel(response, sheetName, title, fileName, crComEdcList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEdcExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd06(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "授信协议编号", "授信机构", "授信额度类型",
				...
				"授信限额编号"};
		// 文件名
		String fileName = "CR_COM_ED06.xlsx";

		try {
			List<CrComEd06> crComEd06List = BaseDAOUtils.getCrComEd06Dao().findByIdProperties(id);
			createCrComEd06Excel(response, sheetName, title, fileName, crComEd06List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd06Excel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEd07(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_ED07.xlsx";

		try {
			List<CrComEd07> crComEd07List = BaseDAOUtils.getCrComEd07DAO().findByIdProperties(id);
			createCrComEd07Excel(response, sheetName, title, fileName, crComEd07List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd07Excel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEd08(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_ED08.xlsx";

		try {
			List<CrComEd08> crComEd08List = BaseDAOUtils.getCrComEd08DAO().findByIdProperties(id);
			createCrComEd08Excel(response, sheetName, title, fileName, crComEd08List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd08Excel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEd09(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-贴现账户分机构汇总信息编号";
		// 标题
		...
		// 文件名
		String fileName = "CR_COM_ED09.xlsx";

		try {
			List<CrComEd09> crComEd09List = BaseDAOUtils.getCrComEd09DAO().findByIdProperties(id);
			createCrComEd09Excel(response, sheetName, title, fileName, crComEd09List);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEd09Excel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEea(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "公用事业缴费账户编号", "公用事业单位名称", "业务类型", "缴费状态", "累计欠费金额", "统计年月",
				"过去 24 个月缴费情况缴费记录条数" };
		// 文件名
		String fileName = "CR_COM_EEA.xlsx";

		try {
			List<CrComEea> crComEeaList = BaseDAOUtils.getCrComEeaDAO().findByIdProperties(id);
			createCrComEeaExcel(response, sheetName, title, fileName, crComEeaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEeaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEe01bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-公共事业缴费信息";
		// 标题
		String[] title = new String[] { "序号", "序号", "统计年月", "缴费状态", "本月应缴金额", "本月实缴金额", "累计欠费金额" };
		// 文件名
		String fileName = "CR_COM_EE01BH.xlsx";

		try {
			List<CrComEe01bh> crComEe01bhList = BaseDAOUtils.getCrComEe01bhDAO().findByIdProperties(id);
			createCrComEe01bhExcel(response, sheetName, title, fileName, crComEe01bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEe01bhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEfa(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-欠税记录信息";
		// 标题
		String[] title = new String[] { "序号", "欠税记录编号", "主管税务机关名称", "欠税总额", "欠税统计时间" };
		// 文件名
		String fileName = "CR_COM_EFA.xlsx";

		try {
			List<CrComEfa> crComEfaList = BaseDAOUtils.getCrComEfaDAO().findByIdProperties(id);
			createCrComEfaExcel(response, sheetName, title, fileName, crComEfaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEfb(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "民事判决记录编号", "民事判决立案法院名称", "民事判决案号", "民事判决立案日期", "民事判决案由", "民事判决诉讼地位",
				...
				"强制执行已执行标的金额" };
		// 文件名
		String fileName = "CR_COM_EFB.xlsx";

		try {
			List<CrComEfb> crComEfbList = BaseDAOUtils.getCrComEfbDAO().findByIdProperties(id);
			createCrComEfbExcel(response, sheetName, title, fileName, crComEfbList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfbExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEfc(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		String[] title = new String[] { "序号", "行政处罚记录编号", "处罚机构名称", "处罚决定书文号", "违法行为", "处罚决定", "处罚日期", "处罚金额", "处罚执行情况",
				"行政复议结果" };
		// 文件名
		String fileName = "CR_COM_EFC.xlsx";

		try {
			List<CrComEfc> crComEfcList = BaseDAOUtils.getCrComEfcDAO().findByIdProperties(id);
			createCrComEfcExcel(response, sheetName, title, fileName, crComEfcList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfcExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEfd(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-行政处罚信息";
		// 标题
		String[] title = new String[] { "序号", "账户编号", "初缴年月", "职工人数", "缴费基数", "最近一次缴费日期", "缴至年月", "缴费状态", "累计欠费金额",
				"统计年月", "缴费记录条数" };
		// 文件名
		String fileName = "CR_COM_EFD.xlsx";

		try {
			List<CrComEfd> crComEfdList = BaseDAOUtils.getCrComEfdDAO().findByIdProperties(id);
			createCrComEfdExcel(response, sheetName, title, fileName, crComEfdList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfdExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEf05bh(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-住房公积金缴费记录信息-过去 24 个月缴费情况信息段-缴费情况信息 ";
		// 标题
		String[] title = new String[] { "序号", "序号", "统计年月", "缴费状态", "本月应缴金额", "本月实缴金额", "累计欠费金额" };
		// 文件名
		String fileName = "CR_COM_EF05BH.xlsx";

		try {
			List<CrComEf05bh> crComEf05bhList = BaseDAOUtils.getCrComEf05bhDAO().findByIdProperties(id);
			createCrComEf05bhExcel(response, sheetName, title, fileName, crComEf05bhList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEf05bhExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEfe(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EFE.xlsx";

		try {
			List<CrComEfe> crComEfeList = BaseDAOUtils.getCrComEfeDAO().findByIdProperties(id);
			createCrComEfeExcel(response, sheetName, title, fileName, crComEfeList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfeExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEff(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EFF.xlsx";

		try {
			List<CrComEff> crComEffList = BaseDAOUtils.getCrComEffDAO().findByIdProperties(id);
			createCrComEffExcel(response, sheetName, title, fileName, crComEffList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEffExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEfg(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-融资规模控制信息";
		// 标题
		String[] title = new String[] { "序号", "信息编号", "所属名录", "融资控制类型", "年度", "规模" };
		// 文件名
		String fileName = "CR_COM_EFG.xlsx";

		try {
			List<CrComEfg> crComEfgList = BaseDAOUtils.getCrComEfgDAO().findByIdProperties(id);
			createCrComEfgExcel(response, sheetName, title, fileName, crComEfgList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEfgExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	...
	public void excelCrComEga(HttpServletResponse response,String id) throws IOException {
		// sheet名
		...
		// 文件名
		String fileName = "CR_COM_EGA.xlsx";

		try {
			List<CrComEga> crComEgaList = BaseDAOUtils.getCrComEgaDAO().findByIdProperties(id);
			createCrComEgaExcel(response, sheetName, title, fileName, crComEgaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEgaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEha(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-评级信息 ";
		// 标题
		String[] title = new String[] { "序号", "评级信息编号", "评级机构名称", "评级日期", "评级结果" };
		// 文件名
		String fileName = "CR_COM_EHA.xlsx";

		try {
			List<CrComEha> crComEhaList = BaseDAOUtils.getCrComEhaDAO().findByIdProperties(id);
			createCrComEhaExcel(response, sheetName, title, fileName, crComEhaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEhaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	...
	public void excelCrComEia(HttpServletResponse response,String id) throws IOException {
		// sheet名
		String sheetName = "征信查询企业征信结果-声明及标注信息  ";
		// 标题
		String[] title = new String[] { "序号", "对象类型", "对象标识", "标注及声明类型", "标注或声明内容", "添加日期" };
		// 文件名
		String fileName = "CR_COM_EIA.xlsx";

		try {
			List<CrComEia> crComEiaList = BaseDAOUtils.getCrComEiaDAO().findByIdProperties(id);
			createCrComEiaExcel(response, sheetName, title, fileName, crComEiaList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void createCrComEiaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEaaWrite(String sheetName, String title[], String fileName,
			List<CrComEaa> list,HttpServletResponse response) {
		logger.info("start create excel-->");
	...
	public void createCrComEaaExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
			List<CrComEaa> list) {
		logger.info("start create excel-->");
		String[][] values = new String[list.size()][];
		for (int i = 0; i < list.size(); i++) {
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEa01ChExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEcaExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEc02OhExcel(HttpServletResponse response,String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEc03OhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEc05OhExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEbaExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
	 ...
	 * @param tcsUserExportList
	 */
	public void createCrComEbbExcel(HttpServletResponse response, String sheetName, String title[], String fileName,
