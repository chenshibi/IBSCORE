package com.huateng.mvc.filter;
...
public class XssFilter implements Filter {
    ...
    public static String stripXSSByOWASP(String value) {
        value = Encode.forHtml(value);
        value = Encode.forJavaScript(value);
        value = Encode.forXml(value);
        return value;
    }
    ...
    private class XSSRequestWrapper extends HttpServletRequestWrapper {
        ...
        private XSSRequestWrapper(HttpServletRequest request) {
            super(request);
        }
        ...
        private String stripXSS(String value) {
            ...
            if (value != null) {
                ...
                cleanValue = stripXSSByOWASP(cleanValue);
