package com.huateng.encrypt.test;
...
import com.huateng.encrypt.utils.Util;
import com.huateng.encrypt.utils.sm2.SM2EncDecUtils;
import com.huateng.encrypt.utils.sm2.SM2KeyVO;
import com.huateng.encrypt.utils.sm2.SM2SignVO;
import com.huateng.encrypt.utils.sm2.SM2SignVerUtils;
import com.huateng.encrypt.utils.sm4.SM4Utils;
...
public class SecurityTestAll {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String src="B2.0.0HBF00000000011BH00000000000120160301123018D10120160301000000010000000000\\r\\n\n" + 
        		"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
        		"<Document>\n" + 
        		"<Head>\n" + 
        		"< QueryOrgCode >HBF00000100001</ QueryOrgCode >\n" + 
        		"<UserCode>002</UserCode>\n" + 
        		"< Password >xcdfnsls</ Password >\n" + 
        		"</Head>\n" + 
        		"<Msg>\n" + 
        		"< OriginateOrgCode >HBF00000100001</ OriginateOrgCode >\n" + 
        		"< OriginateUserCode>002</ OriginateUserCode>\n" + 
        		"< Name>李四</ Name>\n" + 
        		"< IDType >3</ IDType >\n" + 
        		"< IDNum >130429198904571522</ IDNum >\n" + 
        		"< QueryReason>01</ QueryReason>\n" + 
        		"< ServiceCode >yhbgrxybg_02</ ServiceCode >\n" + 
        		"</ Msg>";
