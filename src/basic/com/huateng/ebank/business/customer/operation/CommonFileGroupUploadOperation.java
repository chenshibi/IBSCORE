 ...
 */
public class CommonFileGroupUploadOperation extends BaseOperation {
	private static final HtLog htlog = HtLogFactory
			.getLogger(CommonFileGroupUploadOperation.class);
	...
	public void execute(OperationContext context) throws CommonException {
		...
		try {
			...
			String dp=(String) fieldMap.get("department");
