...
public class TCorpPermitOperation extends BaseOperation {
	private static final HtLog htlog = HtLogFactory.getLogger(TCorpPermitOperation.class);
 	public static final String ID = "customer.TCorpPermitOperation";
	...
	public void execute(OperationContext context) throws CommonException {
		 String cmd = (String) context.getAttribute(CMD);
			...
			try {
		        ...
		        String id=(String) fieldMap.get("form_approveTime");
		        if(date.indexOf("/") > 0){
