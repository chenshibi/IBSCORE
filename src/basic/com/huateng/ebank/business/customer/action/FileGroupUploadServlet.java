...
public class FileGroupUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
				...
				if (!(item.isFormField())) {
					...
					try {
						...
						req.getRequestDispatcher(
								"/fpages/business/ftl/FileGroupUpload.ftl")
								.forward(req, resp);
						e.printStackTrace();
					}
			...
			OPCaller.call(CommonFileGroupUploadOperation.ID, context);
			req.getRequestDispatcher("/fpages/business/ftl/FileGroupUpload.ftl")
					.forward(req, resp);
		} catch (Exception e) {
			e.printStackTrace();
			try {
				...
				req.getRequestDispatcher(
						"/fpages/business/ftl/FileGroupUpload.ftl").forward(
						req, resp);
				e1.printStackTrace();
			}
