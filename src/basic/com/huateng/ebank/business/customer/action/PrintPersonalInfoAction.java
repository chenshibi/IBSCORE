...
public class PrintPersonalInfoAction  extends Action{
	private static final Logger logger = Logger.getLogger(PrintPersonalInfoAction.class);
...
//		System.out.println(htmlpdf);
		...
		stringBuilder.append("<TITLE>IBS个人信息汇总</TITLE>");
