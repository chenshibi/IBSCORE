...
import com.huateng.ebank.business.customer.operation.TCorpPermitOperation2;
...
public class TcorpPermitUploadServletN2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
        ...
        try {
	        ...
	        for(FileItem item : list){
	        	 if(!(item.isFormField())){
	                ...
	                try {
						...
						req.getRequestDispatcher("/fpages/business/ftl/TCorpPermitUploadN2.ftl").forward(req,resp);
            ...
            OPCaller.call(TCorpPermitOperation2.class, context);
