...
import com.huateng.ebank.business.customer.operation.IndPermitOperation2;
...
public class PermitUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
        ...
        try {
        	System.out.println("开始写入indPermit表！");
                ...
                if(!(item.isFormField())){
                    ...
                    try {
    					...
    					ExceptionUtil.throwCommonException("主管批复文件上传失败！");
    					 req.getRequestDispatcher("/fpages/business/ftl/IndPermitUpload.ftl").forward(req,resp);
    					e.printStackTrace();
    				}
            ...
            OPCaller.call(IndPermitOperation2.ID, context);
            req.getRequestDispatcher("/fpages/business/ftl/IndPermitUpload.ftl").forward(req,resp);
        } catch (Exception e) {
            e.printStackTrace();
            try {
