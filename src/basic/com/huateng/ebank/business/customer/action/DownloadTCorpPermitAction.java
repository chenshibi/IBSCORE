...
public class DownloadTCorpPermitAction extends Action{
	private static final Logger logger = Logger.getLogger(DownloadTCorpPermitAction.class);
		...
		try {
			...
			request.setCharacterEncoding("UTF-8");
			  ROOTDAO rootdao = ROOTDAOUtils.getROOTDAO();
				...
				StringBuffer hql = new StringBuffer("select customerConUp from TCorpPermit po where id='"+id+"'");
