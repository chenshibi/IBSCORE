...
public class NaturePersonQueryEmergencyUpdate extends BaseUpdate{
	...
	public UpdateReturnBean saveOrUpdate(
        ...
        oc.setAttribute(NaturePersonQueryEmergencyOperation.IN_PARAM, assureIndAppList);
        OPCaller.call(NaturePersonQueryEmergencyOperation.ID, oc);
