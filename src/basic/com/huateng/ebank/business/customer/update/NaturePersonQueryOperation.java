...
public class NaturePersonQueryOperation extends BaseOperation{
	@SuppressWarnings("unused")
	private static final HtLog htlog = HtLogFactory
			.getLogger(NaturePersonQueryOperation.class);
	public static final String ID = "customer.NaturePersonQueryOperation";
