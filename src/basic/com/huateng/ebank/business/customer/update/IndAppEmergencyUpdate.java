...
import com.huateng.ebank.business.customer.operation.IndAppEmergencyOperation;
...
public class IndAppEmergencyUpdate extends BaseUpdate{
	...
	public UpdateReturnBean saveOrUpdate(
        ...
        oc.setAttribute(IndAppEmergencyOperation.IN_PARAM, inqCustList);
        oc.setAttribute(IndAppEmergencyOperation.IN_COMMONLIST, commonList);
        OPCaller.call(IndAppEmergencyOperation.ID, oc);
        
        String flag=(String)oc.getAttribute(IndAppEmergencyOperation.FLAG);
