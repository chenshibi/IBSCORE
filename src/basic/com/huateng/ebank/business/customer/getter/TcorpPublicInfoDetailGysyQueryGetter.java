 ...
 *
 */
public class TcorpPublicInfoDetailGysyQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicInfoDetail ia where ia.itemName='公共事业过去24个月缴费查询' and ia.rptKey='"+rptKey+"'");
