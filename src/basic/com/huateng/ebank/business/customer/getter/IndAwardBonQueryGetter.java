 ...
 *
 */
public class IndAwardBonQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql1 = new StringBuffer("select ia from IndAward ia where ia.recordType='行政奖励记录' and ia.rptId='"+rptId+"' order by ia.no");
        ...
        for (int i = 0; i < listAward.size(); i++) {
        	...
        	indAward.setContent(listAward.get(i).getContent());
