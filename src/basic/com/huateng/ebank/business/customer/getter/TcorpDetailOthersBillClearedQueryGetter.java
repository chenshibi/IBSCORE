 ...
 *
 */
public class TcorpDetailOthersBillClearedQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='票据贴现' and ia.status='已结清' and ia.rptKey='"+rptKey+"'");
