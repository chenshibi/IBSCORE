 ...
 *
 */
public class TcorpDetailSummaryDraftQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailSummary ia where ia.itemName='银行承兑汇票' and ia.status='未结清' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpDetailSummary.size(); i++) {
		{
        	...
        	tcorpDetailSummary.setBalanceDay30(listTcorpDetailSummary.get(i).getBalanceDay30());
        	tcorpDetailSummary.setBalanceDay60(listTcorpDetailSummary.get(i).getBalanceDay60());
        	tcorpDetailSummary.setBalanceDay90(listTcorpDetailSummary.get(i).getBalanceDay90());
        	tcorpDetailSummary.setBalanceDay90Plus(listTcorpDetailSummary.get(i).getBalanceDay90Plus());
