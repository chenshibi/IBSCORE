 ...
 *
 */
public class TcorpStatementZtQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpStatement ia where ia.itemName='信息主体声明' and ia.rptKey='"+rptKey+"'");
