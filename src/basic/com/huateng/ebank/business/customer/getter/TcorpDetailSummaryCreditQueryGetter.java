 ...
 *
 */
public class TcorpDetailSummaryCreditQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailSummary ia where ia.itemName='信用证' and ia.status='未结清' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpDetailSummary.size(); i++) {
		{
        	...
        	tcorpDetailSummary.setAmount(listTcorpDetailSummary.get(i).getAmount());
