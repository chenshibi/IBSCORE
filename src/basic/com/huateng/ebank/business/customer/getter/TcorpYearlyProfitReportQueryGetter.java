 ...
 *
 */
public class TcorpYearlyProfitReportQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpYearlyReport ia where ia.rptKind='利润表' and  ia.rptKey='"+rptKey+"'");
