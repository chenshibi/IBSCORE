 ...
 *
 */
public class TcorpPublicAwardCrjQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicAward ia where ia.itemName='出入境检验检疫绿色通道信息' and ia.rptKey='"+rptKey+"'");
