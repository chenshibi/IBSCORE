 ...
 *
 */
public class TcorpDetailOthersPjtxMxQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='票据贴现' and ia.status='已结清正常' and ia.rptKey='"+rptKey+"'");
