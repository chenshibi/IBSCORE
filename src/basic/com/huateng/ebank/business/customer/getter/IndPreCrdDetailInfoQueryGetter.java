 ...
 *
 */
public class IndPreCrdDetailInfoQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql3 = new StringBuffer("select id from IndDetailInfo id where id.rptId='"+rptId+"' and id.code='BILLDAY' and id.type='LOAN' order by id.no");
