 ...
 *
 */
public class TcorpHistoryRecordMyrzQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpHistoryRecord ia where ia.itemName='贸易融资' and ia.extensionName='"+historyRecord+"' and ia.rptKey='"+rptKey+"'");
