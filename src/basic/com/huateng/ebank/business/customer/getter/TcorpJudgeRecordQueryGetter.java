 ...
 *
 */
public class TcorpJudgeRecordQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpJudgeRecord ia where ia.itemName='民事判决记录' and ia.rptKey='"+rptKey+"'");
        List<TCorpJudgeRecord> listTcorpJudgeRecord = rootdao.queryByCondition(hql.toString());
    	   for (int i = 0; i < listTcorpJudgeRecord.size(); i++) {
        	...
        	tcorpJudgeRecord.setJudgeParty(listTcorpJudgeRecord.get(i).getJudgeParty());
        	tcorpJudgeRecord.setCaseNo(listTcorpJudgeRecord.get(i).getCaseNo());
        	tcorpJudgeRecord.setJudgeProcess(listTcorpJudgeRecord.get(i).getJudgeProcess());
        	...
        	tcorpJudgeRecord.setJudgeEffDate(listTcorpJudgeRecord.get(i).getJudgeEffDate());
        	tcorpJudgeRecord.setJudgeResult(listTcorpJudgeRecord.get(i).getJudgeResult());
