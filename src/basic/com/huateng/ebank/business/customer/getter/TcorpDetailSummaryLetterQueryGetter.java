 ...
 *
 */
public class TcorpDetailSummaryLetterQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailSummary ia where ia.itemName='保函' and ia.status='未结清' and ia.rptKey='"+rptKey+"'");
