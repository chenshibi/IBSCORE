 ...
 *
 */
public class IndPublicRecordForceQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql1 = new StringBuffer("select ia from IndPublicRecord ia where ia.recordType='民事判决记录' and ia.rptId='"+rptId+"' order by ia.no");
        ...
        for (int i = 0; i < listPublicRecord.size(); i++) {
        	...
        	indPublicRecord.setStatus(listPublicRecord.get(i).getStatus());
        	...
        	indPublicRecord.setObjectName(listPublicRecord.get(i).getObjectName());
        	indPublicRecord.setObjectAmount(listPublicRecord.get(i).getObjectAmount());
