 ...
 *
 */
public class IndAssuranceDetailLoanQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql1 = new StringBuffer("select ia from IndAssuranceDetail ia where ia.type='贷款' and ia.rptId='"+rptId+"' order by ia.no");
       ...
       if(listAssuranceDetail.size()>0){
        	...
        	indAssuranceDetail.setEndDate(listAssuranceDetail.get(0).getEndDate());
        	...
        	indAssuranceDetail.setL5class(listAssuranceDetail.get(0).getL5class());
