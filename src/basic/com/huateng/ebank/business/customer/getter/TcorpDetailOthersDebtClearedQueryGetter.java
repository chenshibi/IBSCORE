 ...
 *
 */
public class TcorpDetailOthersDebtClearedQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='由资产管理公司处置的债务' and ia.status='已结清' and ia.rptKey='"+rptKey+"'");
