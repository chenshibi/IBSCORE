 ...
 *
 */
public class TcorpDetailAssureWindowsQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        for (int i = 0; i < listTcorpDetailAssureWindows.size(); i++) {
					if("未结清贷款".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						...
						tcorpDetailAssureWindows.setBalance(listTcorpDetailAssureWindows.get(i).getBalance());
						tcorpDetailAssureWindows.setFiveLevel(listTcorpDetailAssureWindows.get(i).getFiveLevel());
						tcorpDetailAssureWindows.setAssureStatus(listTcorpDetailAssureWindows.get(i).getAssureStatus());
						tcorpDetailAssureWindows.setTitle(listTcorpDetailAssureWindows.get(i).getTitle());
						list.add(tcorpDetailAssureWindows);
						
					}else if("未结清贸易融资".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						TCorpDetailAssureWindows tcorpDetailAssureWindows=new TCorpDetailAssureWindows();
					...
					}else if("未结清保理".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						TCorpDetailAssureWindows tcorpDetailAssureWindows=new TCorpDetailAssureWindows();
					...
					}else if("未结清银行承兑汇票".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						TCorpDetailAssureWindows tcorpDetailAssureWindows=new TCorpDetailAssureWindows();
					...
					}else if("未结清信用证".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						TCorpDetailAssureWindows tcorpDetailAssureWindows=new TCorpDetailAssureWindows();
					...
					}else if("未结清保函".equals(listTcorpDetailAssureWindows.get(i).getTitle())){
						TCorpDetailAssureWindows tcorpDetailAssureWindows=new TCorpDetailAssureWindows();
