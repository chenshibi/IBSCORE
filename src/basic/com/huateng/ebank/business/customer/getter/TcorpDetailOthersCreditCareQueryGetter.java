 ...
 *
 */
public class TcorpDetailOthersCreditCareQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='信用证' and ia.status='未结清' and ia.fiveLevel='关注' and ia.rptKey='"+rptKey+"'");
