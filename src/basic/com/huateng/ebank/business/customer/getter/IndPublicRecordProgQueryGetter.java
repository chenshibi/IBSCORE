 ...
 *
 */
public class IndPublicRecordProgQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql1 = new StringBuffer("select ia from IndPublicRecord ia where ia.recordType='行政处罚记录' and ia.rptId='"+rptId+"' order by ia.no");
