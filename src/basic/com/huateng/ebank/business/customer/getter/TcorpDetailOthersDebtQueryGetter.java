 ...
 *
 */
public class TcorpDetailOthersDebtQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='由资产管理公司处置的债务' and ia.status='未结清' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpDetailOthers.size(); i++) {
		{
        	...
        	tcorpDetailOthers.setUpdateDate(listTcorpDetailOthers.get(i).getUpdateDate());
