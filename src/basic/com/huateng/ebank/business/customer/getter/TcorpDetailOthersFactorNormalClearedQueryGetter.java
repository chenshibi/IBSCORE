 ...
 *
 */
public class TcorpDetailOthersFactorNormalClearedQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='保理' and ia.status='已结清' and ia.rptKey='"+rptKey+"'");
