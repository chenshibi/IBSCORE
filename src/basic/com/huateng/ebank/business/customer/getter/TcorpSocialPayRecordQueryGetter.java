 ...
 *
 */
public class TcorpSocialPayRecordQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpSocialPayRecord ia where ia.itemName='社会保险参保缴费记录' and ia.rptKey='"+rptKey+"'");
        List<TCorpSocialPayRecord> listTcorpSocialPayRecord = rootdao.queryByCondition(hql.toString());
    	   for (int i = 0; i < listTcorpSocialPayRecord.size(); i++) {
        	...
        	tcorpSocialPayRecord.setInsuranceType(listTcorpSocialPayRecord.get(i).getInsuranceType());
        	tcorpSocialPayRecord.setInsuredDate(listTcorpSocialPayRecord.get(i).getInsuredDate());
