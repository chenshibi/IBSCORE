 ...
 *
 */
public class TcorpPublicAwardJgQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicAward ia where ia.itemName='进出口商品检验分类监管信息' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpPublicAward.size(); i++) {
		{
        	...
        	tcorpPublicAward.setSubOrgan(listTcorpPublicAward.get(i).getSubOrgan());
