 ...
 *
 */
public class TcorpPublicAwardRewardQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicAward ia where ia.itemName='获得奖励记录' and ia.rptKey='"+rptKey+"'");
