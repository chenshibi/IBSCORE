 ...
 *
 */
public class TcorpPublicAwardZlQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicAward ia where ia.itemName='拥有专利情况' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpPublicAward.size(); i++) {
		{
        	...
        	tcorpPublicAward.setAwardCode(listTcorpPublicAward.get(i).getAwardCode());
        	...
        	tcorpPublicAward.setTerm(listTcorpPublicAward.get(i).getTerm());
