 ...
 *
 */
public class TcorpDetailOthersInterestQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='欠息' and ia.status='未结清' and ia.rptKey='"+rptKey+"'");
