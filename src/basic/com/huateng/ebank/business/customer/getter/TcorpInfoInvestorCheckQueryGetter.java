 ...
 *
 */
public class TcorpInfoInvestorCheckQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        for (int i = 0; i < listTcorpInfoInvestor.size(); i++) {
		{
        	...
        	tcorpInfoInvestor.setName(listTcorpInfoInvestor.get(i).getName());
        	tcorpInfoInvestor.setIdType(listTcorpInfoInvestor.get(i).getIdType());
        	tcorpInfoInvestor.setIdNumber(listTcorpInfoInvestor.get(i).getIdNumber());
