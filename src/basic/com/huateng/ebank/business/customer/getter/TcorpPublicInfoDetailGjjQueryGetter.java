 ...
 *
 */
public class TcorpPublicInfoDetailGjjQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicInfoDetail ia where ia.itemName='住房公积金过去24个月缴费查询' and ia.rptKey='"+rptKey+"'");
