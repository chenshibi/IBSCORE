 ...
 *
 */
public class EachDepartmentQueryEntNumsGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        EachDepartmentQueryEntNumsBean bean = null;
        /*每日时间*/
        Date startTm = null;
		Date endTm = null;
		...
		*/
        ...
        hql.append("select t.DEPARTMENT as department,'' as QueryCycle,count(t.DEPARTMENT) as queryTimes from CUST_PBOC_ENT_QUERY  c LEFT JOIN TLR_INFO t on c.CREATE_USER =t.TLRNO WHERE 1=1");
        ...
        while(it.hasNext()){
        	Map map = (Map)it.next();
        	bean=new EachDepartmentQueryEntNumsBean();
