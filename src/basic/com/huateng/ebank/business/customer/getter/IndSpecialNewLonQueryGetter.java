 ...
 *
 */
public class IndSpecialNewLonQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql1 = new StringBuffer("select id from IndSpecialNew id where id.rptId='"+rptId+"' and accType='LOAN' order by id.no");
        List<IndSpecialNew> listIndSpecial = rootdao.queryByCondition(hql1.toString());
        StringBuffer hql2 = new StringBuffer("select id from IndDetailInfo id where id.rptId='"+rptId+"' and id.code='ORGDESC' and id.type='LOAN' order by id.no");
        List<IndDetailInfo> listIndDetailInfo = rootdao.queryByCondition(hql2.toString());
        StringBuffer hql3 = new StringBuffer("select id from IndDetailInfo id where id.rptId='"+rptId+"' and id.code='SELFSTATEMENT' and id.type='LOAN' order by id.no");
        List<IndDetailInfo> listIndDetailInfo1 = rootdao.queryByCondition(hql3.toString());
        StringBuffer hql4 = new StringBuffer("select id from IndDetailInfo id where id.rptId='"+rptId+"' and id.code='DISSENT’' and id.type='LOAN' order by id.no");
        List<IndDetailInfo> listIndDetailInfo2 = rootdao.queryByCondition(hql4.toString());
        if(listIndSpecial.size()>0){
