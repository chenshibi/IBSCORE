 ...
 *
 */
public class TcorpOrginalDetailWindowsDkQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpOrginalDetailWindows ia where ia.itemName='信用证信息' and ia.rptKey='"+rptKey+"'");
