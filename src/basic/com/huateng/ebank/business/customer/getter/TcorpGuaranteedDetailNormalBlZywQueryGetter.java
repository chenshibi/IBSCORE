 ...
 *
 */
public class TcorpGuaranteedDetailNormalBlZywQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpGuaranteedDetail ia where ia.type='质押物信息' and ia.assuredName='"+assured+"' and ia.rptKey='"+rptKey+"'");
