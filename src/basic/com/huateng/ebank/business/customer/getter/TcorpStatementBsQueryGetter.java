 ...
 *
 */
public class TcorpStatementBsQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpStatement ia where ia.itemName='报数机构说明' and ia.rptKey='"+rptKey+"'");
