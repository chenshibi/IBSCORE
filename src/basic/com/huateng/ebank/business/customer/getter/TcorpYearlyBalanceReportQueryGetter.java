 ...
 *
 */
public class TcorpYearlyBalanceReportQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpYearlyReport ia where ia.rptKind='资产负债表' and  ia.rptKey='"+rptKey+"'");
