 ...
 *
 */
public class TcorpPublicAwardMjQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpPublicAward ia where ia.itemName='进出口商品免检信息' and ia.rptKey='"+rptKey+"'");
