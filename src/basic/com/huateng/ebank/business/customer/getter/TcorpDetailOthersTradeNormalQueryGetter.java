 ...
 *
 */
public class TcorpDetailOthersTradeNormalQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='贸易融资' and ia.status='未结清' and ia.fiveLevel='' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpDetailOthers.size(); i++) {
		{
        	...
        	tcorpDetailOthers.setExtended(listTcorpDetailOthers.get(i).getExtended());
        	tcorpDetailOthers.setHistoryRecord(listTcorpDetailOthers.get(i).getHistoryRecord());
