 ...
 *
 */
public class TcorpDetailOthersDkModLoanMaxQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
	    ...
	    StringBuffer hql = new StringBuffer("select count(id) from TCorpDetailOthers ia where ia.itemName='类贷款' and ia.status='已结清正常' and ia.rptKey='"+rptKey+"'");
