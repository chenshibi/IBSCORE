 ...
 *
 */
public class TcorpGuaranteedDetailNormalBlDywQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpGuaranteedDetail ia where ia.type='抵押物信息' and ia.assuredName='"+assured+"' and ia.rptKey='"+rptKey+"'");
       ...
       for (int i = 0; i < listTcorpGuaranteedDetail.size(); i++) {
			...
			tcorpGuaranteedDetail.setAssureKind(listTcorpGuaranteedDetail.get(i).getAssureKind());
			tcorpGuaranteedDetail.setCurrency(listTcorpGuaranteedDetail.get(i).getCurrency());
			tcorpGuaranteedDetail.setValuation(listTcorpGuaranteedDetail.get(i).getValuation());
