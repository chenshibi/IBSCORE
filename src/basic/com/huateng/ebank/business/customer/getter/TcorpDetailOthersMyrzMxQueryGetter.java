 ...
 *
 */
public class TcorpDetailOthersMyrzMxQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select ia from TCorpDetailOthers ia where ia.itemName='贸易融资' and ia.status='已结清正常' and ia.rptKey='"+rptKey+"'");
