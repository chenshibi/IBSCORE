 ...
 *
 */
public class TotalTcorpDetailOthersDkMxQueryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
        ...
        StringBuffer hql = new StringBuffer("select count(id) as query from TCorpDetailOthers ia where ia.itemName='贷款' and ia.status='已结清正常' and ia.rptKey='"+rptKey+"'");
