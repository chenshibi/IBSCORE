...
public class RoleMngCheckGetter extends BaseGetter {
    ...
    private PageQueryResult getData() throws AppException {
         ...
         * hql.append(" and dd.intInsId= ? "); condList.add(intInsId); }
         */
        hql.append(" and dd.intInsId= '100299' ");
