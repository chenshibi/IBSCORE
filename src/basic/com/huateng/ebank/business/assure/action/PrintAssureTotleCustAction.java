...
public class PrintAssureTotleCustAction  extends Action{
	private static final Logger logger = Logger.getLogger(PrintAssureTotleCustAction.class);
...
//		System.out.println(htmlpdf);
		...
		stringBuilder.append("<TITLE>自然人对外担保汇总</TITLE>");
