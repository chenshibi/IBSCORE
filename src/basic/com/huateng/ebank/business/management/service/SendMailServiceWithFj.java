...
public class SendMailServiceWithFj {
	private static Log log = LogFactory.getLog(SendMailServiceWithFj.class);
	public static void sendMail(String msgType,MailBean bean,String[] fileDataSource) throws Exception{
				...
				try {
				    ...
				    //添加附件
					 if(fileDataSource.length != 0){
			                for(String attachFile : fileDataSource){
			                	if(null!=attachFile){
...
//					}
	...
	public static void getMailBeanAndSendMail(String msgType, String mailContentBody,String title,String[] fileDataSource) throws Exception{
		...
		if(mailBean != null){
			sendMail(msgType,mailBean,fileDataSource);
		}
