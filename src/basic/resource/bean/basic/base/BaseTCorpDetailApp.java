...
public abstract class BaseTCorpDetailApp implements Serializable {
	...
	public static String REF = "TCorpDetailApp";
	...
	public BaseTCorpDetailApp() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	
	public BaseTCorpDetailApp(int hashCode, Integer id, String rptKey, Date createTime, String loanCardNo,
	...
	public int hashCode() {
		...
		result = prime * result + ((loanCardNo == null) ? 0 : loanCardNo.hashCode());
		result = prime * result + ((loanCardPass == null) ? 0 : loanCardPass.hashCode());
		result = prime * result + ((parsedTime == null) ? 0 : parsedTime.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BaseTCorpDetailApp other = (BaseTCorpDetailApp) obj;
		if (createTime == null) {
	...
	public String toString() {
		return "BaseTCorpDetailApp [hashCode=" + hashCode + ", id=" + id + ", rptKey=" + rptKey + ", createTime="
				+ createTime + ", loanCardNo=" + loanCardNo + ", loanCardPass=" + loanCardPass + ", queryReason="
				+ queryReason + ", type=" + type + ", status=" + status + ", statusMsg=" + statusMsg + ", inputTime="
				+ inputTime + ", returnTime=" + returnTime + ", parsedTime=" + parsedTime + ", queryTime=" + queryTime
				+ "]";
	}
