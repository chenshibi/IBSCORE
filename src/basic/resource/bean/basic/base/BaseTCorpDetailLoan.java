...
public abstract class BaseTCorpDetailLoan implements Serializable {
	...
	public static String REF = "TCorpDetailLoan";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BaseTCorpDetailLoan other = (BaseTCorpDetailLoan) obj;
		if (amount == null) {
	...
	public BaseTCorpDetailLoan(int hashCode, Integer id, String rptKey,
