...
public class BaseAssureBatchInfo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1193315165723168094L;
	
	public static String REF = "AssureBatchInfo";
	...
	public String toString() {
		return "BaseAssureBatchInfo [hashCode=" + hashCode + ", id=" + id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BaseAssureBatchInfo other = (BaseAssureBatchInfo) obj;
		if (appId == null) {
			if (other.appId != null)
				return false;
	...
	public BaseAssureBatchInfo(int hashCode, Integer id, String rptKey,
