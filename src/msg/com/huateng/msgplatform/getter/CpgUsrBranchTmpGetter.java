 ...
 *
 */
public class CpgUsrBranchTmpGetter extends BaseGetter {
    ...
    protected PageQueryResult getData() throws Exception {
        ...
        // if("new".equals(type)){return new PageQueryResult();}
        ...
        hql.append("select po from CpgMsgUsrBranchTmp po where 1=1 ");
        if (!DataFormat.isEmpty(innerId)) {
