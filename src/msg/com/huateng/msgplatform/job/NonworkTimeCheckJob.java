...
public class NonworkTimeCheckJob implements org.quartz.StatefulJob {
    @SuppressWarnings("unused")
	private Logger htlog = Logger.getLogger(NonworkTimeCheckJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
		    ...
		    String starTime=lists.get(0).getParamVal().replace(":", "");
		    String endTime=liste.get(0).getParamVal().replace(":", "");
            ...
            //add by chensibi 通知的时间要为标准格式 start
            String yesterday1=new SimpleDateFormat("yyyy-MM-dd").format(cal.getTime());
            String endTime1=liste.get(0).getParamVal();
            DateFormat fmt1 =new SimpleDateFormat("yyyy-MM-dd");//年月日
            String day1=fmt1.format(startTm);//获取当前时间的年月日
            String starTime1=lists.get(0).getParamVal();
	  	    //add by chensibi 通知的时间要为标准格式 end
	  	    
            List listInq = new ArrayList<CustPbocPerQuery>();
            StringBuffer hql = new StringBuffer("select count(*) as numbers ,createUser from CustPbocPerQuery po where 1=1");
            ...
            content+="During"+yesterday1+" "+endTime1+"'"+"to "+day1+" "+starTime1+"'"+" below user just performed  bureau enquiry during non-working hours.";
            content+="<br/>";
            ...
            StringBuffer hqlc = new StringBuffer("select count(*) as numbers ,createUser from CustPbocEntQuery po where 1=1");
            ...
            content1+="During"+yesterday1+" "+endTime1+"'"+"to "+day1+" "+starTime1+"'"+" below user just performed  bureau enquiry during non-working hours.";
            content1+="<br/>";
