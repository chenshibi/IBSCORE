...
/**
 * 六个月查询少于20笔的用户锁定，域值可以配置，发邮件给锁定用户
 * @author chensibi
 *
 */
public class CheckUserNoQuery2Job implements org.quartz.StatefulJob{
	 private Logger htlog = Logger.getLogger(CheckUserNoQuery2Job.class);
	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		//获取系统参数
		 SysParamsDAO dao=DAOUtils.getSysParamsDAO();
         List list=dao.findByProperty("paramName", "6个月查询笔数");
