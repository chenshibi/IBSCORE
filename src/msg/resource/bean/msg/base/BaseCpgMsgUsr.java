...
/**
 * This is an object that contains data related to the CPG_MSG_USR table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_USR"
 */

public abstract class BaseCpgMsgUsr implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgUsr() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgUsr(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgUsr))
            return false;
        else {
            resource.bean.msg.CpgMsgUsr affenterprise = (resource.bean.msg.CpgMsgUsr) obj;
