...
/**
 * This is an object that contains data related to the CPG_USR_INF table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="CPG_USR_INF"
 */

public abstract class BaseCpgUsrInf implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgUsrInf() {
        initialize();
    }
     ...
     */
    public BaseCpgUsrInf(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgUsrInf))
            return false;
        else {
            resource.bean.msg.CpgUsrInf affenterprise = (resource.bean.msg.CpgUsrInf) obj;
