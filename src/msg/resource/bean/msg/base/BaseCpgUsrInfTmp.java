...
/**
 * This is an object that contains data related to the CPG_USR_INF_TMP table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="CPG_USR_INF_TMP"
 */

public abstract class BaseCpgUsrInfTmp implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgUsrInfTmp() {
        initialize();
    }
     ...
     */
    public BaseCpgUsrInfTmp(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgUsrInfTmp))
            return false;
        else {
            resource.bean.msg.CpgUsrInfTmp affenterprise = (resource.bean.msg.CpgUsrInfTmp) obj;
