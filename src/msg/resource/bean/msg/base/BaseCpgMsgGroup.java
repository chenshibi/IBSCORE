...
/**
 * This is an object that contains data related to the CPG_MSG_GROUP table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_GROUP"
 */

public abstract class BaseCpgMsgGroup implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgGroup() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgGroup(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgGroup))
            return false;
        else {
            resource.bean.msg.CpgMsgGroup affenterprise = (resource.bean.msg.CpgMsgGroup) obj;
