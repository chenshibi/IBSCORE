...
//
//public class BaseCpgMsgSndCtlTmp {
//
//}
...
/**
 * This is an object that contains data related to the CPG_MSG_SND_CTL_TMP
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_SND_CTL_TMP"
 */

public abstract class BaseCpgMsgSndCtlTmp implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgSndCtlTmp() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgSndCtlTmp(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    private java.lang.String oppIdType;
    ...
    public java.lang.String getOppIdType() {
        return oppIdType;
    }

    public void setOppIdType(java.lang.String oppIdType) {
        this.oppIdType = oppIdType;
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgSndCtlTmp))
            return false;
        else {
            resource.bean.msg.CpgMsgSndCtlTmp affenterprise = (resource.bean.msg.CpgMsgSndCtlTmp) obj;
