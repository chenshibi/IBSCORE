...
/**
 * This is an object that contains data related to the CPG_MSG_SND_CTL table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_SND_CTL"
 */

public abstract class BaseCpgMsgSndCtl implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgSndCtl() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgSndCtl(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgSndCtl))
            return false;
        else {
            resource.bean.msg.CpgMsgSndCtl affenterprise = (resource.bean.msg.CpgMsgSndCtl) obj;
