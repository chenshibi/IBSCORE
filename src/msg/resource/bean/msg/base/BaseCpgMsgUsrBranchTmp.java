...
/**
 * This is an object that contains data related to the CPG_MSG_USR_BRANCH_TMP
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_USR_BRANCH_TMP"
 */

public abstract class BaseCpgMsgUsrBranchTmp implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgUsrBranchTmp() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgUsrBranchTmp(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgUsrBranchTmp))
            return false;
        else {
            resource.bean.msg.CpgMsgUsrBranchTmp affenterprise = (resource.bean.msg.CpgMsgUsrBranchTmp) obj;
