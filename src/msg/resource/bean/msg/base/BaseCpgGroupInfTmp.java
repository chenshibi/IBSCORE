...
/**
 * This is an object that contains data related to the CPG_GROUP_INF_TMP table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="CPG_GROUP_INF_TMP"
 */

public abstract class BaseCpgGroupInfTmp implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgGroupInfTmp() {
        initialize();
    }
     ...
     */
    public BaseCpgGroupInfTmp(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgGroupInfTmp))
            return false;
        else {
            resource.bean.msg.CpgGroupInfTmp affenterprise = (resource.bean.msg.CpgGroupInfTmp) obj;
