...
//
//public class BaseCpgMsgGroupTmp {
//
//}
...
/**
 * This is an object that contains data related to the CPG_MSG_GROUP_TMP table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="CPG_MSG_GROUP_TMP"
 */

public abstract class BaseCpgMsgGroupTmp implements Serializable {

    private static final long serialVersionUID = 1L;

    // constructors
    public BaseCpgMsgGroupTmp() {
        initialize();
    }
     ...
     */
    public BaseCpgMsgGroupTmp(java.lang.String id) {
        this.setId(id);
        initialize();
    }
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof resource.bean.msg.CpgMsgGroupTmp))
            return false;
        else {
            resource.bean.msg.CpgMsgGroupTmp affenterprise = (resource.bean.msg.CpgMsgGroupTmp) obj;
